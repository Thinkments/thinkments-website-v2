...
sharp('public/favicon-16x16.svg').resize(16, 16).png().toFile('public/favicon-16x16.png');

sharp('public/favicon-32x32.svg').resize(32, 32).png().toFile('public/favicon-32x32.png');

sharp('public/apple-touch-icon.svg').resize(180, 180).png().toFile('public/apple-touch-icon.png');
