...
export default function LocalSEOPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Appearing prominently in Google Maps results drives foot traffic and local awareness. We optimize your Google Maps presence through strategic keyword placement, compelling business descriptions, high-quality photos, regular posts, and accurate service area definitions. Strong Maps visibility puts you in front of ready-to-buy local customers.',
      linkTo: null,
    },
    {
      icon: Code,
  ...
  const targetAudiences = [
    {
      ...
      description:
        'Retail stores, restaurants, professional offices, and local service providers serving a specific city or region',
    },
    {
      icon: Wrench,
      title: 'Service-Area Businesses',
      description:
        'Plumbers, electricians, HVAC contractors, landscapers, and other businesses serving customers at their locations',
    },
    {
      icon: UtensilsCrossed,
      title: 'Restaurants & Retail',
      description:
        'Establishments that depend on foot traffic and local customers finding them through search',
    },
    {
      icon: Stethoscope,
      title: 'Healthcare Practices',
      description:
        'Dental offices, medical practices, chiropractors, therapists, and healthcare providers serving local patients',
    },
    {
      icon: Scale,
      title: 'Professional Services',
      description:
        'Lawyers, accountants, financial advisors, and consultants attracting clients from their local area',
    },
    {
      icon: Target,
      title: 'Any Local Business',
      description:
        'If you want customers from your local area to find you when they search, local SEO is essential',
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        'We analyze your current local search presence, Google Business Profile, citations, online reviews, local rankings, and competitors. This comprehensive audit identifies gaps and opportunities to improve your local visibility and create a strategic roadmap.',
      duration: '1-2 weeks',
    },
    {
      phase: '2',
      title: 'Google Business Profile Optimization',
      description:
        'We optimize or create your Google Business Profile with accurate information, compelling descriptions, strategic categories, high-quality photos, service areas, business hours, and all relevant details. This is the foundation of local SEO success.',
      duration: '1 week',
    },
    {
      phase: '3',
      ...
      description:
        'We build and optimize citations across major directories (Yelp, Facebook, Apple Maps, Bing Places) and industry-specific platforms. We ensure NAP consistency across all listings and fix any incorrect or duplicate listings that hurt your rankings.',
      duration: '2-4 weeks',
    },
    {
      phase: '4',
      ...
      description:
        'We optimize your website for local search with location-specific keywords, local landing pages, schema markup, internal linking, and mobile optimization. Content is created or enhanced to target local search intent and establish local authority.',
      duration: '3-4 weeks',
    },
    {
      phase: '5',
      ...
      description:
        'We implement a systematic review generation process, set up review monitoring, and develop response strategies. Positive reviews are encouraged through follow-up campaigns, while negative reviews are addressed professionally to protect your reputation.',
      duration: 'Ongoing',
    },
    {
      phase: '6',
      ...
      description:
        'Local SEO requires continuous attention. We monitor local rankings, track leads and calls, analyze Google Business Profile insights, maintain citations, generate content, and provide detailed monthly reports showing progress toward your local visibility goals.',
      duration: 'Ongoing',
    },
  ];
  ...
  const results = [
    ...
    },
    {
      ...
      description:
        'Measurable increase in phone calls, direction requests, and contact form submissions',
      icon: Phone,
      color: 'text-[#F7B928]',
    },
    {
        ...
        <section className="relative bg-gradient-to-br from-[#1E3A5F] via-[#234B70] to-[#2C5282] text-white py-20 lg:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <h1 className="mb-6">Local SEO Services for Texas Businesses</h1>

              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Get found by customers in your area. We help Decatur and North Texas businesses
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Local SEO (Search Engine Optimization) is the practice of optimizing your online
                  presence to attract customers from local searches. Unlike traditional SEO that
                  targets a broad national or international audience, local SEO focuses on ranking
                  for searches in specific geographic areas—your city, region, or service area.
                </p>

                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  When someone searches for "plumber near me," "best restaurant in Decatur," or
                  "accountant in North Texas," local SEO determines which businesses appear. It
                  combines Google Business Profile optimization, local content, online reviews,
                  citations, and technical optimizations to improve your visibility where it matters
                  most—in front of nearby customers ready to buy.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive local SEO solutions designed to increase your visibility, attract
                local customers, and drive real business results.
              </p>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  If you serve customers in a specific geographic area, local SEO is essential to
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  A systematic approach to improving your local search visibility and attracting
                  nearby customers.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Local SEO success is measured by real business outcomes—rankings, traffic, and
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
                  From small local shops to multi-location service businesses, we've helped North
                  Texas companies dominate local search results. Our data-driven approach focuses on
                  metrics that matter: visibility, traffic, and revenue from local customers.
                </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-2xl mx-auto">
                Get found by customers in Decatur, North Texas, and beyond. Let's create a local SEO
