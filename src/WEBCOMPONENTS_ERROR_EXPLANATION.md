...
The error occurs because Figma Make's overlay system is trying to register a custom web component (
`mce-autosize-textarea`) multiple times, likely due to hot module replacement (HMR) during
development.
...
The Web Components API intentionally throws this error to prevent namespace conflicts, but in this
case it's a false positive from HMR.
...
**Claude says**: This is just development noise from Figma Make's internal tooling. Your site is
working perfectly. Focus on creating great content and ignore this error completely. 🎯
