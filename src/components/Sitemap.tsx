...
const generateSitemap = (): string => {
  ...
  const mainRoutes: SitemapURL[] = [
    ...
    {
      loc: '/artificial-intelligence-optimization',
      lastmod: today,
      changefreq: 'weekly',
      priority: '0.8',
    },
    ...
    {
      loc: '/Google-Business-Profile-Growth-Managed-Essentials',
      lastmod: today,
      changefreq: 'weekly',
      priority: '0.8',
    },
    {
      loc: '/Google-Business-Profile-Professional-Complete-Management',
      lastmod: today,
      changefreq: 'weekly',
      priority: '0.8',
    },
    {
      loc: '/Google-Business-Profile-Foundation-Audit-&-Setup',
      lastmod: today,
      changefreq: 'weekly',
      priority: '0.8',
    },
    {
      loc: '/Google-Business-Profile-Concierge-Ultimate-Visibility',
      lastmod: today,
      changefreq: 'weekly',
      priority: '0.8',
    },
    {
      loc: '/Google-Business-Profile-Growth-Enhanced-Essentials',
      lastmod: today,
      changefreq: 'weekly',
      priority: '0.8',
    },
...
const SitemapComponent: React.FC = () => {
  ...
  const routes = [
    ...
    { path: '/videography', priority: '0.8', changefreq: 'weekly', description: 'Videography' },
    {
      ...
      priority: '0.8',
      changefreq: 'weekly',
      description: 'Google Business Profile Growth: Managed Essentials',
    },
    {
      path: '/Google-Business-Profile-Professional-Complete-Management',
      priority: '0.8',
      changefreq: 'weekly',
      description: 'Silver - Google Business Profile Professional Complete Management',
    },
    {
      path: '/Google-Business-Profile-Foundation-Audit-&-Setup',
      priority: '0.8',
      changefreq: 'weekly',
      description: 'Foundation: Audit & Setup - Google Business Profile',
    },
    {
      path: '/Google-Business-Profile-Concierge-Ultimate-Visibility',
      priority: '0.8',
      changefreq: 'weekly',
      description: 'Einsteinium: Ultimate Visibility - Google Business Profile',
    },
    {
      path: '/Google-Business-Profile-Growth-Enhanced-Essentials',
      priority: '0.8',
      changefreq: 'weekly',
      description: 'Gold: Enhanced Essentials - Google Business Profile',
    },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-muted-foreground mb-8">
        Explore all pages on our website. This sitemap helps search engines crawl and index our
        content.
      </p>
