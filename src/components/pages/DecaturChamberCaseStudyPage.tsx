      ...
      <section className="relative py-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              How we created a single platform that serves local businesses, attracts tourists, and preserves Decatur's rich history
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="text-xl md:text-2xl leading-relaxed text-center text-muted-foreground">
                The Decatur Chamber of Commerce is more than a business organization—it's the heartbeat of commerce in Wise County, Texas. But their digital presence wasn't keeping pace with the community's growth. They didn't just need a website; they needed a platform that could serve multiple audiences simultaneously: local businesses seeking resources, tourists planning visits, residents exploring their community, and history enthusiasts preserving the past. ThinkMents built exactly that—a{' '}
                <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              ...
              <Card className="bg-gradient-to-br from-muted/30 to-background border-primary/20">
                <CardContent className="p-8">
                  <p className="text-lg mb-6 leading-relaxed">
                    The Decatur Chamber of Commerce faced a unique challenge: they needed to serve vastly different audiences with completely different needs, all through a single digital platform.
                  </p>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-lg italic leading-relaxed">
                      "The Chamber needed to answer the question: 'What is Decatur?' for business owners, tourists, and residents alike—all in one place."
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-muted/30 to-background border-primary/20">
                <CardContent className="p-8">
                  <p className="text-lg leading-relaxed">
                    The stakes were real: an ineffective Chamber website meant businesses didn't see value in membership, tourists went elsewhere, and{' '}
                    <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">
                ThinkMents built a comprehensive website that serves as three platforms in one: a Business Hub, a Tourism Gateway, and a Historical Archive. Each section serves its audience while contributing to a unified picture of Decatur.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: 'Instead of building separate websites for business, tourism, and history, we created an integrated platform where each section reinforces the others. A tourist exploring "things to do" might discover a Chamber member\'s business. A business owner researching Decatur finds the historical context that makes the city special.',
                  icon: Layers
                },
                {
                  number: '2',
                  title: 'Content depth that builds authority',
                  description: 'With 80+ pages of quality content, the website became the definitive resource for all things Decatur. This depth isn\'t just good for SEO—it serves real users with real questions and establishes the Chamber as the authority on the community.',
                  icon: FileText
                },
                {
                  number: '3',
                  title: 'Built for sustainability',
                  description: 'The content management system makes updates easy for Chamber staff. The structure is flexible enough to grow. The foundation supports whatever Decatur becomes in the future.',
                  icon: Shield
                }
              ].map((factor, index) => (
                <motion.div
              ...
              {[
                {
                  ...
                  quote: 'Before, our membership was about networking events and a decal for the window. Now, every member has real online visibility. That\'s tangible value that justifies their dues.'
                },
                {
                  icon: Store,
                  title: 'For Local Businesses',
                  quote: 'When someone searches for restaurants in Decatur or shops in Wise County, our members show up. We\'re helping local businesses compete with chains and online retailers.'
                },
                {
                  icon: MapPin,
                  title: 'For Tourism',
                  quote: 'Decatur used to be a drive-through town on the way to somewhere else. Now visitors can see we\'re a destination worth stopping for—or planning a whole trip around.'
                },
                {
                  icon: BookOpen,
                  title: 'For History',
                  quote: 'We have stories and photos that would have been lost forever. Now they\'re preserved digitally, accessible to anyone, and connected to the living community.'
                },
                {
                  icon: TrendingUp,
                  title: 'For Economic Development',
                  quote: 'When a business considers relocating to Decatur, the website tells our story better than any brochure. It shows we\'re a real, vibrant community that supports businesses.'
                }
              ].map((impact, index) => (
                <motion.div
                  key={index}
                ...
                <CardContent className="p-12">
                  <div className="text-center">
                    ...
                    <blockquote className="text-2xl md:text-3xl mb-8 italic leading-relaxed">
                      "ThinkMents understood that we weren't just building a website—we were building a digital home for our entire community. The platform has exceeded our expectations and become essential to how we serve our members and promote Decatur."
                    </blockquote>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Whether you're a Chamber of Commerce, economic development organization, or community group, we can build a digital hub that brings everyone together.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-sm text-muted-foreground">
              ThinkMents is based in Decatur, Texas—and we're proud to serve the community we call home. We bring the same dedication to every client, whether they're down the street or across the state.
            </p>
          </motion.div>
        </div>
      </section>
