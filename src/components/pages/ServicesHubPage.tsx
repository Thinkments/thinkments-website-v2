...
export default function ServicesHubPage() {
  ...
  const featuredServices = [
    {
      image:
        'https://images.unsplash.com/photo-1634814251396-479adacfc527?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHwzNjAlMjBjYW1lcmElMjB2aXJ0dWFsJTIwdG91cnxlbnwxfHx8fDE3NjU0MDAxOTV8MA&ixlib=rb-4.1.0&q=80&w=1080',
      badge: 'PIONEER SINCE 2008',
      badgeColor: 'bg-[#FF6B35]',
      title: 'Immersive Experiences & Virtual Tours',
      description:
        "We created the first virtual real estate tour in North Texas, the first arena seat preview with Mark Cuban, and the first museum tour. From Google Street View to Matterport, we're the immersive experts.",
      services: [
        'Google Street View',
        '360° Photography',
        'Matterport 3D Tours',
    ...
    {
      image:
        'https://images.unsplash.com/photo-1744900647430-965ccc7a6078?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBSSUyMGFydGlmaWNpYWwlMjBpbnRlbGxpZ2VuY2UlMjBpbnRlcmZhY2V8ZW58MXx8fHwxNzY1NDAwMTk2fDA&ixlib=rb-4.1.0&q=80&w=1080',
      badge: 'NEW CAPABILITIES',
      badgeColor: 'bg-[#00B4D8]',
      title: 'AI & Automation',
      description:
        "The future of marketing is here. We're integrating AI tools like ChatGPT, Claude, and custom solutions to automate reporting, generate content, build chatbots, and optimize for AI search engines.",
      services: [
    ...
    {
      image:
        'https://images.unsplash.com/photo-1559989899-f0743fa80152?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnb29nbGUlMjBidXNpbmVzcyUyMHByb2ZpbGUlMjBtb2JpbGV8ZW58MXx8fHwxNzY1NDAwMTk2fDA&ixlib=rb-4.1.0&q=80&w=1080',
      badge: 'GBP EXPERTS',
      badgeColor: 'bg-[#00B4D8]',
      title: 'Google Business Profile Management',
      description:
        'Your GBP is often the first impression customers have. We handle everything from setup and verification to optimization, posting, review management, and suspension recovery.',
      services: [
        'Setup & Verification',
        'Optimization',
        'Google Posts',
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="py-16 md:py-20 bg-[#1E3A5F] text-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed">
              From local SEO to AI automation, virtual tours to video production—we have every tool
              your business needs to dominate online. And we've been perfecting them for over 20
              years.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              These are the services that set us apart—our deepest expertise and biggest
              differentiators.
            </p>
          </motion.div>
              ...
              >
                <Card className="h-full hover:shadow-2xl transition-all duration-300 overflow-hidden rounded-lg group">
                  <div className="relative h-56 overflow-hidden">
                    ...
                    />
                    <Badge
                      className={`absolute top-4 left-4 ${service.badgeColor} text-white border-none`}
                    >
                      {service.badge}
                    </Badge>
                  </div>
                  ...
                  <Card className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-[#00B4D8] rounded-lg group cursor-pointer">
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <h3 className="font-semibold text-[#1E3A5F] text-lg">{category.title}</h3>
                        {category.badge && (
                          <Badge
                            className={`${
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
              Book a free consultation and we'll help you identify the services that will have the
