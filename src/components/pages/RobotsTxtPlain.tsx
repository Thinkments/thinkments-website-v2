...
# Note: This file is served at https://thinkments.com/robots-txt
# Search engines can discover it via the robots meta tag or direct linking`;

export default function RobotsTxtPlain() {
  useEffect(() => {
