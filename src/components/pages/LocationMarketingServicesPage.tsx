...
export default function LocationMarketingServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Consistent business information across the web reinforces your local search authority. We build and manage citations on major directories (Yelp, Yellow Pages, BBB), industry-specific directories, and local business listings. We ensure your Name, Address, and Phone (NAP) are identical everywhere, fixing inconsistencies that confuse search engines and customers. Our citation management prevents duplicate listings and keeps information current.',
    },
    {
      icon: MessageSquare,
      title: 'Reputation Management',
      description:
        'Online reviews directly impact local search rankings and customer decisions. We implement systematic review generation strategies that encourage satisfied customers to share their experiences on Google, Facebook, Yelp, and industry-specific platforms. We monitor all reviews across platforms, craft professional responses, and help you maintain the stellar reputation that drives local business.',
    },
    {
      icon: Link2,
      title: 'Local Link Building',
      description:
        'Build location-specific authority through strategic local link building. We identify opportunities with local chambers of commerce, business associations, community organizations, local news sites, and complementary local businesses. These locally-relevant backlinks strengthen your geographic authority and improve local search rankings. We also pursue local sponsorship and partnership opportunities that generate both links and community goodwill.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Google Business Profile optimizations often show impact within 2-4 weeks. Local SEO typically demonstrates meaningful ranking improvements in 2-4 months, with compounding results over 6-12 months.',
    },
    {
      question: 'We serve a large geographic area—can you help?',
      answer:
        "Absolutely. We specialize in marketing for businesses serving multiple cities or large service territories. We'll create targeted strategies for priority markets and scale as results justify expansion.",
    },
    {
      question: 'Do I need a physical address for local SEO?',
      answer:
        'Service-area businesses can rank locally without displaying an address. We optimize for SAB (service-area business) requirements while maximizing your visibility in the areas you serve.',
    },
    {
      question: 'How is location marketing different from regular SEO?',
      answer:
        "Location marketing emphasizes geographic relevance—local keywords, Google Business Profile, citations, local links, and proximity signals. It's SEO with a hyperlocal focus.",
    },
    {
      question: 'Can you help with just one location?',
      answer:
        'Yes! Whether you have one location or one hundred, we tailor strategies to your specific situation and goals.',
    },
    {
      question: 'What areas do you serve?',
      answer:
        'We help businesses across Texas and in 31 states nationwide with location marketing strategies.',
    },
  ];
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1569336415962-a4bd9f69cd83?w=1080&fit=crop)',
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Put your business in front of customers exactly when and where they're searching for
                your services
              </p>
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Location-based marketing puts your business in front of customers exactly when and
                where they're searching for your services. Whether someone is looking for 'plumber
                near me' on their phone or searching for the best restaurant in a specific
                neighborhood, location marketing ensures your business appears at the moment of
                highest intent.{' '}
                <strong>
                  ThinkMents has specialized in local and location-based marketing since 2002—long
                  before smartphones made 'near me' searches a daily occurrence.
                </strong>{' '}
                With over 20 years of experience helping businesses dominate their local markets, we
                understand how to leverage location data, local search algorithms, and geographic
                targeting to drive real customers through your doors.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <Card className="border-t-4 border-t-[#00B4D8] text-center">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      'Near me' searches have increased in recent years
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-t-4 border-t-[#00B4D8] text-center">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      of mobile searchers are more likely to contact a local business with a
                ...
                <Card className="border-t-4 border-t-[#00B4D8] text-center">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      Local searches lead mobile users to visit stores within one day
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="bg-[#F8F9FA] rounded-lg p-6">
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  ...
                  <strong>
                    it's about being found at the exact moment someone is ready to buy.
                  </strong>{' '}
                  A person searching 'emergency plumber near me' at 10 PM has immediate intent. A
                  tourist searching 'best tacos downtown' is ready to walk in your door. Location
                  marketing captures these high-intent moments.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  For service-area businesses, local retailers, restaurants, healthcare providers,
                  and professional services,{' '}
                  <strong>
                    location marketing isn't optional—it's essential for survival and growth.
                  </strong>
                </p>
              </div>
            </div>
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-white/90">
                If your business travels to customers, location marketing requires specialized
                approaches
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 space-y-6">
              <div>
                ...
                <p className="text-white/90 leading-relaxed">
                  We help you define and communicate your service area effectively. This includes
                  setting appropriate service areas in Google Business Profile, creating service
                  area pages on your website, and targeting advertising to your actual coverage
                  zones.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-white/90 leading-relaxed">
                  For businesses serving multiple cities without physical locations in each, we
                  create optimized landing pages for every city in your service area. Each page
                  targets local keywords, addresses city-specific needs, and includes local trust
                  signals.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-white/90 leading-relaxed">
                  We optimize for the increasingly common 'near me' searches that don't specify a
                  location. This involves mobile optimization, local schema markup, and proximity
                  signals that help you appear when customers search generically.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-white/90 leading-relaxed">
                  Geotargeted ad campaigns reach customers throughout your service territory. We can
                  target specific cities, radius from your base, or custom-drawn boundaries matching
              ...
              <div className="bg-[#FF6B35] rounded-lg p-6 mt-6">
                <p className="text-white text-lg leading-relaxed">
                  <strong>
                    We understand the unique challenges of marketing a business without a storefront
                    in every location you serve.
                  </strong>{' '}
                  Plumbers, HVAC technicians, landscapers, mobile services, home healthcare—we've
                  got you covered.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
              <div>
                <h3 className="text-2xl text-[#1E3A5F] mb-3">
                  Centralized Strategy, Local Execution
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  We develop overarching strategies that maintain brand standards while allowing
                  location-specific customization. Each market gets attention tailored to its
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Efficiently manage Google Business Profiles across all locations with consistent
                  information, regular posts, and review monitoring. We use enterprise tools to
                  scale what would otherwise require individual attention to each listing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Track key metrics for every location in unified dashboards. Compare performance
                  across markets, identify underperforming locations, and allocate resources based
                  on data.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  We can train and support local managers to handle day-to-day marketing tasks while
                  maintaining brand standards and reporting into central systems.
                </p>
              </div>
              ...
              <div className="bg-[#F8F9FA] rounded-lg p-6 border-l-4 border-[#00B4D8]">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>
                    Whether you're a regional chain or a national franchise, we build scalable
                    location marketing systems that grow with you.
                  </strong>{' '}
                  Maintaining brand consistency while adapting to local markets, managing dozens or
                  hundreds of Google Business Profiles, and tracking performance across
                  locations—ThinkMents brings order to multi-location marketing.
                </p>
              </div>
            </div>
          </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    'Patient acquisition for practices serving defined geographic areas. HIPAA-compliant strategies that drive appointments.',
                },
                {
                  title: 'Home Services',
                  description:
                    'Service-area optimization for contractors, HVAC, plumbing, electrical, and home improvement businesses.',
                },
                {
                  title: 'Restaurants & Hospitality',
                  description:
                    'Driving foot traffic through local search, review management, and location-based social media.',
                },
                {
                  title: 'Retail',
                  description:
                    'Combining online visibility with in-store traffic generation. Local inventory ads and store locator optimization.',
                },
                {
                  title: 'Professional Services',
                  description:
                    'Building local authority for attorneys, accountants, consultants, and agencies serving geographic markets.',
                },
                {
                  title: 'Real Estate',
                  description:
                    'Hyperlocal marketing for agents and brokerages targeting specific neighborhoods and communities.',
                },
                {
                  title: 'Automotive',
                  description:
                    'Dealership and service center marketing reaching customers in defined market areas.',
                },
              ].map((industry, idx) => (
                <motion.div
                  key={idx}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">How we build your location marketing strategy</p>
            </div>
            ...
            <div className="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-l-[#FF6B35]">
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>
                  Monthly reporting shows exactly how location marketing is impacting your business
                </strong>
                —local rankings, GBP metrics, leads by location, and ROI.
              </p>
            </div>
          </motion.div>
        </div>
