  ...
  const types = [
    {
      ...
      description:
        'Immersive, navigable experiences that let viewers explore every angle of your space. Viewers can look up, down, and all around, moving through your location as if they were there. Perfect for showcasing the complete environment and spatial relationships within your business.',
    },
    {
      icon: Building,
      title: 'Matterport 3D Tours',
      description:
        'Digital twin technology that creates dimensionally accurate 3D models. Viewers can explore in walkthrough mode, dollhouse view, or floor plan view. Includes automatic measurements—ideal for real estate, construction, and any application requiring precise spatial documentation.',
    },
    {
      icon: MapPin,
      title: 'Google Street View Tours',
      description:
        "Interior tours published directly to Google Maps and Search. When customers find your business on Google, they can explore inside before visiting. As Google Street View trusted photographers, we capture and publish tours that appear in the world's most-used mapping platform.",
    },
    {
      icon: Video,
      title: 'Guided Video Tours',
      description:
        'Narrated video walkthroughs that tell a story while showcasing your space. Combine the engagement of video with the exploration of virtual tours. Perfect for properties or venues where context and storytelling enhance the experience.',
    },
    {
      icon: Plane,
      title: 'Aerial Virtual Tours',
      description:
        '360° panoramas captured from above with FAA-licensed drones. Showcase properties, campuses, and surroundings from stunning aerial perspectives. Ideal for real estate, resorts, golf courses, and locations where the surrounding environment matters.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Basic 360° tours start around $300-500 for small spaces. Matterport 3D tours and larger properties range from $500-2,000+. We provide custom quotes based on your space and requirements.',
    },
    {
      question: 'How long does a virtual tour last?',
      answer:
        'Tours remain accessible as long as you maintain hosting. We offer affordable annual hosting, and Google Street View tours are permanently free once published.',
    },
    {
      question: 'Can virtual tours be updated?',
      answer:
        'Yes. If your space changes significantly, we can recapture and update. Minor updates may not require a full reshoot.',
    },
    {
      question: 'Do virtual tours work on mobile devices?',
      answer:
        'Absolutely. Our tours work on smartphones, tablets, and desktops with no special apps required. VR headset viewing is also supported.',
    },
    {
      question: 'How do customers find my virtual tour?',
      answer:
        'Tours embed on your website, appear on Google Maps (Street View tours), and can be shared via links on social media, email, and listing platforms.',
    },
  ];
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1497366216548-37526070297c?w=1080&fit=crop)',
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Virtual tours have transformed how customers explore spaces before visiting in
                person. From real estate to hospitality to retail, businesses that offer virtual
                tours capture more attention, build more trust, and convert more customers than
                those relying on static photos alone.{' '}
                <strong>
                  ThinkMents pioneered virtual tour technology in North Texas—we created the
                  region's first virtual real estate tour and built the first arena seat preview
                  system with Mark Cuban's American Airlines Center.
                </strong>{' '}
                With over 20 years of immersive content experience, we create virtual tours that
                don't just showcase your space—they drive real business results.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                <strong>Customers today expect to explore before they commit.</strong> Whether
                choosing a hotel room, previewing a wedding venue, touring a home, or evaluating a
                senior living facility, they want to experience the space virtually first.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Virtual tours also extend your geographic reach indefinitely. Customers from
                anywhere in the world can "visit" your location, breaking down distance barriers
                that limit traditional marketing.
              </p>
            </div>
          </motion.div>
        </div>
              ...
              {[
                {
                  title: 'Real Estate',
                  description:
                    'Residential and commercial property tours that let buyers explore homes remotely, qualify interest, and schedule viewings only for properties they love.',
                },
                {
                  title: 'Hotels & Resorts',
                  description:
                    'Room tours, amenity showcases, and property overviews that increase booking confidence and reduce "surprise" complaints upon arrival.',
                },
                {
                  title: 'Event Venues',
                  description:
                    'Wedding venues, conference centers, and event spaces that let planners explore options virtually before site visits.',
                },
                {
                  title: 'Restaurants & Bars',
                  description:
                    'Atmosphere showcases that give diners a feel for your space before they reserve.',
                },
                {
                  title: 'Senior Living',
                  description:
                    'Facility tours that help families research options without the stress of multiple in-person visits.',
                },
                {
                  title: 'Retail & Showrooms',
                  description:
                    'Virtual store experiences that let customers browse your showroom from anywhere.',
                },
                {
                  title: 'Educational Institutions',
                  description: 'Campus tours that reach prospective students worldwide.',
                },
              ].map((industry, idx) => (
                <Card
                  key={idx}
              ...
              {[
                {
                  ...
                  items: [
                    'Site assessment and capture planning',
                    'Optimal scheduling for lighting',
                ...
                },
                {
                  title: 'Capture Day',
                  items: [
                    'Professional 360° equipment',
                    'Multiple positions for complete coverage',
                    'Quality review on-site',
                  ],
                },
                {
                  title: 'Post-Production',
                  items: [
                    'Professional stitching and processing',
                    'Navigation and hotspot creation',
                ...
                },
                {
                  title: 'Delivery',
                  items: [
                    'Web hosting and embedding',
                    'Google Street View publishing',
                    'Training on sharing and promotion',
                  ],
                },
              ].map((phase, idx) => (
