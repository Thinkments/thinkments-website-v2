...
export default function PaidAdvertisingPage() {
  ...
  const schemas = [
    generateServiceSchema({
      ...
      description: 'Professional paid advertising management in Texas. Google Ads, YouTube advertising, Local Service Ads, and job board campaigns.',
      url: `${BASE_URL}/services/paid-advertising`,
    }),
    generateLocalBusinessSchema(),
