...
export default function PaidAdvertisingPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Google Guaranteed ads for service businesses in eligible categories. Show up at the very top of Google with the trusted checkmark badge. Pay only for qualified leads, not clicks. We handle verification, profile optimization, and lead management to help you dominate local search results.',
    ...
    },
    {
      ...
      description: 'Recruitment advertising across Indeed, ZipRecruiter, LinkedIn, and niche job boards. We write compelling job descriptions, target the right candidates, manage budgets across platforms, and track applicant quality. Perfect for businesses struggling to fill positions in competitive hiring markets.',
    ...
    },
    {
      ...
      description: 'Bring back website visitors who didn\'t convert the first time. Using pixel tracking and audience segmentation, we show relevant ads to previous visitors across Google Display, YouTube, and social platforms. Retargeting typically converts 3-5x better than cold traffic and dramatically improves overall campaign ROI.',
    ...
    },
    {
      ...
      description: 'Compelling ad copy and eye-catching visuals designed to stop scrollers and drive clicks. We A/B test headlines, descriptions, images, and calls-to-action to identify winning combinations. Professional creative services ensure your ads stand out in crowded feeds and search results.',
  ...
  const caseStudies = [
    ...
    },
    {
      ...
      metric: '$12',
      label: 'Cost Per Lead',
      description: 'Reduced cost per qualified lead from $85 to $12 through strategic optimization.'
    },
    {
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1648134859177-525771773915?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnb29nbGUlMjBhZHMlMjBkYXNoYm9hcmQlMjBtZXRyaWNzfGVufDF8fHx8MTc2NTQwMDY1NHww&ixlib=rb-4.1.0&q=80&w=1080)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Strategic ad campaigns across Google, YouTube, and job boards that deliver measurable ROI. We manage millions in ad spend—and we treat your budget like it's our own.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-700 leading-relaxed mb-6">
                Paid advertising delivers immediate visibility and measurable results when done correctly. At ThinkMents, we've managed over $2M in ad spend across Google Ads, YouTube, social media platforms, and job boards—consistently delivering 3-5x return on ad spend for our clients. Unlike agencies that profit from spending more of your budget, we charge flat management fees aligned with your success.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Our team includes Google-certified professionals with decades of combined experience running campaigns across every major advertising platform. We don't just set up campaigns and hope for the best—we continuously optimize based on real performance data, conduct rigorous A/B testing, and make strategic adjustments to maximize your ROI. Whether you're spending $1,000 or $100,000 per month, we treat every dollar like it's our own.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                From local service businesses in Texas to national e-commerce brands, we've helped hundreds of businesses achieve their advertising goals. Our approach combines data-driven strategy, compelling creative, precise targeting, and relentless optimization to ensure your ads reach the right people at the right time with the right message.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                <Card className="h-full hover:shadow-xl transition-shadow duration-300 rounded-lg overflow-hidden">
                  <CardContent className="p-8">
                    ...
                    <div className="text-5xl font-bold text-[#00B4D8] mb-2">
                      {study.metric}
                    </div>
                    <p className="font-semibold text-[#1E3A5F] mb-4">
                      {study.label}
                    </p>
                    <p className="text-gray-600 leading-relaxed">
                      {study.description}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1E3A5F] mb-8 text-center" style={{ fontFamily: 'Playfair Display, serif' }}>
              Who Paid Advertising Is For
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Businesses Needing Immediate Results</h3>
                  <p className="text-gray-700">Unlike SEO which takes months, paid ads drive traffic and leads immediately. Perfect for new businesses or seasonal campaigns.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Service Businesses</h3>
                  <p className="text-gray-700">HVAC, plumbing, legal, dental, and home services that need qualified local leads from Google and Local Service Ads.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">E-commerce & Online Retailers</h3>
                  <p className="text-gray-700">Shopping campaigns and retargeting that drive product sales with measurable ROAS.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Businesses Hiring Employees</h3>
                  <p className="text-gray-700">Companies struggling to fill positions can use job board advertising to reach qualified candidates faster.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">B2B Companies</h3>
                  <p className="text-gray-700">LinkedIn and Google Ads targeting decision-makers at specific companies to generate enterprise leads.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Businesses Scaling Growth</h3>
                  <p className="text-gray-700">Companies ready to invest in predictable, scalable lead generation to fuel expansion.</p>
                </CardContent>
              </Card>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">We charge flat management fees, not a percentage of ad spend. This means our incentives align with yours—we focus on efficiency and results, not inflating your budget.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl text-[#1E3A5F] mb-3">Google-Certified Experts</h3>
                  <p className="text-gray-700 leading-relaxed">Our team holds Google Ads certifications and manages campaigns daily. We stay current with platform changes, new features, and best practices.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl text-[#1E3A5F] mb-3">Full Transparency</h3>
                  <p className="text-gray-700 leading-relaxed">You own your ad accounts and data. We provide complete access, detailed reporting, and clear explanations of what we're doing and why.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl text-[#1E3A5F] mb-3">Continuous Optimization</h3>
                  <p className="text-gray-700 leading-relaxed">We don't "set and forget." Daily monitoring, weekly adjustments, and monthly strategy sessions ensure campaigns improve over time.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-[#1E3A5F] to-[#00B4D8] rounded-2xl p-8 text-white">
            ...
            <blockquote className="text-xl italic mb-6">
              "ThinkMents took over our Google Ads and reduced our cost per lead by 60% while increasing conversions. They actually know what they're doing, unlike our previous agency."
            </blockquote>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              <div key={idx} className="border border-gray-200 rounded-lg p-6 hover:border-[#00B4D8] transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Get a free audit of your current campaigns and see where you're leaving money on the table.
            </p>
        ...
        services={[
          {
            icon: Share2,
            title: 'Social Media',
            description: 'Build your brand and engage your audience with strategic social media management and content.',
            href: '/social-media'
          },
          {
            icon: BarChart3,
            title: 'Analytics & Reporting',
            description: 'Data-driven insights and comprehensive reporting to track performance and optimize marketing ROI.',
