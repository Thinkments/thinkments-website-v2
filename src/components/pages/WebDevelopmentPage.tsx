  ...
  const faqs = [
    {
      ...
      answer: 'Custom websites typically range from $3,500 for small business sites to $15,000+ for complex e-commerce or custom functionality. We provide detailed quotes after understanding your specific needs.'
    },
    {
      question: 'How long does it take to build a website?',
      answer: 'Most websites launch within 6-10 weeks depending on complexity and how quickly content and feedback are provided. We\'ll give you a specific timeline during discovery.'
    },
    {
      question: 'Do I need to provide content?',
      answer: 'We can work with content you provide, or we offer copywriting services to create compelling website content. Stock images and professional photography coordination available.'
    },
    {
      question: 'Will I be able to update the website myself?',
      answer: 'Yes. We build on user-friendly content management systems and provide training. You\'ll be able to update text, images, and basic content easily.'
    },
    {
      question: 'What about hosting?',
      answer: 'We recommend reliable hosting providers and can set up hosting for you. We also offer managed hosting with our maintenance plans.'
    },
    {
      question: 'Do you redesign existing websites?',
      answer: 'Absolutely. Website redesigns are a significant part of our work. We preserve your SEO equity while dramatically improving design and performance.'
    },
    {
      question: 'What if I need changes after launch?',
      answer: '30 days of post-launch support is included. Beyond that, we offer hourly support or monthly maintenance plans for ongoing needs.'
    },
    {
      question: 'Do you build mobile apps?',
      answer: 'We build mobile-friendly websites and progressive web apps (PWAs). For native iOS/Android apps, we can recommend trusted partners.'
    }
  ];
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Your website is the foundation of your digital presence—and often the first impression potential customers have of your business. <strong>At ThinkMents, we've been building websites since 2002, long before WordPress became mainstream or mobile-responsive design was even a concept.</strong> Over two decades, we've developed hundreds of websites for businesses across 31 states, from simple brochure sites to complex e-commerce platforms. Our approach combines stunning design with technical excellence and marketing strategy—because a beautiful website that doesn't generate leads is just an expensive digital brochure. We build websites that work as hard as you do.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Your website isn't just a digital business card—it's your most powerful marketing asset
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">of consumers judge credibility based on website design</p>
                </CardContent>
              </Card>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                A poorly designed, slow, or outdated website actively costs you customers. <strong>Every day with a subpar website is a day you're losing business to competitors with better online presence.</strong>
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                The good news? A professionally built website pays for itself through increased leads, improved credibility, and better search visibility. <strong>We don't just build websites—we build revenue-generating digital assets.</strong>
              </p>
            </div>
          </motion.div>
        </div>
              ...
              {[
                {
                  ...
                  items: ['Kickoff meeting to understand your business and goals', 'Target audience and competitor research', 'Content inventory and sitemap development', 'Technical requirements definition', 'Timeline and milestone planning']
                },
                {
                  phase: 'Phase 2: Design (Weeks 2-4)',
                  items: ['Wireframes showing page structure and layout', 'Visual design concepts based on your brand', 'Homepage and key page mockups', 'Revision rounds until you love it', 'Final design approval']
                },
                {
                  phase: 'Phase 3: Development (Weeks 4-7)',
                  items: ['Front-end development (what visitors see)', 'Back-end development (functionality and CMS)', 'Mobile responsiveness across all devices', 'Forms, integrations, and features', 'Content population']
                },
                {
                  phase: 'Phase 4: Testing & QA (Week 7-8)',
                  items: ['Cross-browser testing (Chrome, Safari, Firefox, Edge)', 'Mobile device testing (iOS, Android)', 'Form and functionality testing', 'Speed optimization', 'SEO technical checklist', 'Accessibility review']
                },
                {
                  phase: 'Phase 5: Launch & Training (Week 8-9)',
                  items: ['Final client review and approval', 'Domain and hosting configuration', 'Website launch', 'CMS training for your team', 'Post-launch monitoring', 'Handoff documentation']
                },
                {
                  phase: 'Phase 6: Ongoing Support',
                  items: ['30 days of post-launch support included', 'Available maintenance plans for ongoing needs', 'Always here when you need us']
                }
              ].map((phase, idx) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    {['Custom design (no templates)', 'Mobile-responsive across all devices', 'Intuitive navigation and user flow', 'Conversion-optimized layouts'].map((item, idx) => (
              ...
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    {['Fast loading speeds (under 3 seconds)', 'SSL security certificate setup', 'SEO-friendly architecture', 'Schema markup for search engines', 'XML sitemap and robots.txt'].map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">{item}</span>
                      </li>
              ...
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    {['Contact forms with spam protection', 'Google Analytics integration', 'Google Search Console setup', 'Social media integration', 'Newsletter signup integration (if needed)'].map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">{item}</span>
                      </li>
              ...
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    {['CMS training for your team', '30 days of included support', 'Documentation and login credentials', 'Hosting recommendations and setup assistance'].map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">{item}</span>
                      </li>
              ...
              {[
                {
                  ...
                  description: 'We\'ve built websites since before CSS was widely supported. This experience means we\'ve solved every problem, adapted to every technology shift, and know what actually works.'
                },
                {
                  title: 'Marketing-Focused Development',
                  description: 'We\'re marketers who build websites, not just developers. Every site we create is built to generate leads and support your marketing goals—not just look pretty.'
                },
                {
                  title: 'No Outsourcing',
                  description: 'Your website is built by our team, not shipped overseas to anonymous contractors. You know who\'s working on your project.'
                },
                {
                  title: 'Long-Term Partnership',
                  description: 'We\'re here after launch for support, updates, and improvements. Many clients have worked with us for 10+ years.'
                },
                {
                  title: 'Transparent Process',
                  description: 'You\'re involved at every stage. No surprises, no scope creep, no mystery about what\'s happening with your project.'
                }
              ].map((reason, idx) => (
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-8 text-center">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                We've built websites for healthcare practices, law firms, home service companies, restaurants, e-commerce stores, and businesses across dozens of industries.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Startups and new companies needing professional online presence from day one.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Businesses with Outdated Websites</h3>
                  <p className="text-gray-700">Companies losing customers to competitors because of slow, non-mobile, or unprofessional sites.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">E-commerce Businesses</h3>
                  <p className="text-gray-700">Online retailers needing robust platforms that handle products, payments, and customers seamlessly.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Service Businesses</h3>
                  <p className="text-gray-700">HVAC, plumbers, lawyers, dentists, and local services converting website visitors into customers.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Growing Companies</h3>
                  <p className="text-gray-700">Businesses outgrowing their current website's capabilities and needing enterprise-level solutions.</p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Multi-Location Businesses</h3>
                  <p className="text-gray-700">Franchises and businesses with multiple locations needing coordinated web presence.</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link to="/widgets-integrations" className="text-[#00B4D8] hover:underline flex items-center gap-1">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Let's discuss your project and build a website that attracts visitors and converts them into customers.
            </p>
