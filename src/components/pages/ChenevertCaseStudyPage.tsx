  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=1080&fit=crop)',
            ...
            >
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Marketing & SEO', 'Web Development', 'Google Business Profile', 'Content Marketing'].map((service, idx) => (
                    <span 
                      key={idx}
            ...
            {[
              {
                ...
                description: 'Their website was buried on page 5+ of Google search results for key service terms. Potential customers searching for their services were finding competitors instead. Their Google Business Profile was incomplete and had minimal reviews, making them virtually invisible in local map results.'
              },
              {
                title: 'Outdated Website',
                description: 'Their existing website was over 5 years old, not mobile-friendly, and loaded slowly. The design looked dated compared to competitors, undermining credibility with potential customers. There were no clear calls-to-action, and the contact form was buried and rarely used.'
              },
              {
                title: 'No Marketing Strategy',
                description: 'Chenevert had tried various marketing tactics over the years—a little social media here, some print ads there—but nothing was coordinated or measurable. They had no way to track what was working and were essentially throwing money at random tactics hoping something would stick.'
              },
              {
                title: 'Inconsistent Lead Flow',
                description: 'Business came primarily through word-of-mouth referrals, which was unpredictable. Some months were busy, others were slow. They needed a reliable, consistent source of new customers to plan for growth and hire additional staff.'
              },
              {
                title: 'Competitive Market',
                description: 'Their local market included several well-established competitors with strong online presences, bigger marketing budgets, and years of accumulated reviews. Breaking through seemed nearly impossible with their limited resources.'
              },
              {
                title: 'Previous Agency Disappointment',
                description: 'Before finding ThinkMents, Chenevert had worked with another marketing agency that overpromised and underdelivered. They were skeptical about whether digital marketing could actually work for their business.'
              }
            ].map((challenge, idx) => (
              <motion.div
                key={idx}
              ...
              <Card className="border-l-4 border-[#00B4D8]">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6 ml-13">
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Website Redesign:</h4>
                      <p className="text-gray-600 leading-relaxed">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Google Business Profile Optimization:</h4>
                      <p className="text-gray-600 leading-relaxed">
            ...
            >
              <Card className="border-l-4 border-[#00B4D8]">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6 ml-13">
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Search Engine Optimization:</h4>
                      <p className="text-gray-600 leading-relaxed">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Local SEO Focus:</h4>
                      <p className="text-gray-600 leading-relaxed">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Content Marketing:</h4>
                      <p className="text-gray-600 leading-relaxed">
            ...
            >
              <Card className="border-l-4 border-[#00B4D8]">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6 ml-13">
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Performance Analysis:</h4>
                      <p className="text-gray-600 leading-relaxed">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Conversion Rate Optimization:</h4>
                      <p className="text-gray-600 leading-relaxed">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#1E3A5F] text-lg mb-2">Review Generation:</h4>
                      <p className="text-gray-600 leading-relaxed">
            ...
            {[
              {
                ...
                description: 'Before driving traffic, you need a website that converts. Investing in a professional, fast, mobile-friendly website paid dividends throughout the entire campaign.'
              },
              {
                icon: Globe,
                title: 'Local SEO Matters',
                description: 'For service-area businesses, Google Business Profile optimization and local SEO are often the fastest path to results. Being visible in map results drives immediate calls and leads.'
              },
              {
                icon: TrendingUp,
                title: 'Patience Pays Off',
                description: 'SEO is a long-term investment. While we saw early wins, the compounding effect of consistent optimization delivered the biggest results over 6-12 months.'
              },
              {
                icon: Star,
                title: 'Reviews Build Trust',
                description: 'A systematic approach to generating reviews transformed Chenevert\'s online reputation, directly impacting both search visibility and conversion rates.'
              },
              {
                icon: BarChart,
                title: 'Measure Everything',
                description: 'By tracking every lead source, we could prove ROI and make data-driven decisions about where to invest resources.'
              },
              {
                icon: Target,
                title: 'Success is Repeatable',
                description: 'The strategies that worked for Chenevert can work for similar businesses facing the same challenges. This success model is proven and repeatable.'
              }
            ].map((takeaway, idx) => (
              <motion.div
                key={idx}
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                { name: 'Google Business Profile Management', link: '/google-business-profile', icon: Star },
                { name: 'Content Marketing', link: '/content-marketing', icon: FileText },
                { name: 'Reputation Management', link: '/reputation-management', icon: MessageSquare }
              ].map((service, idx) => (
                <motion.div
                  key={idx}
      ...
      <section ref={relatedRef} className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <Button asChild size="lg" variant="outline" className="border-2 border-[#00B4D8] text-[#00B4D8] hover:bg-[#00B4D8] hover:text-white">
