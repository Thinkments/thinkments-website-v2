  ...
  const services = [
    {
      ...
      description:
        'Custom strategy based on your goals, audience, and industry. Not cookie-cutter plans.',
      price: 'From $500',
      badge: null,
    },
    {
    ...
    },
    {
      ...
      description:
        'Full-service management of your social accounts. Posting, engagement, and growth.',
      price: 'From $600/mo',
      badge: null,
    },
    {
      ...
      description:
        'Paid campaigns on Facebook, Instagram, and LinkedIn that reach your ideal customers.',
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2NpYWwlMjBtZWRpYSUyMGRhc2hib2FyZCUyMGFuYWx5dGljc3xlbnwxfHx8fDE3NjUyOTcwMjN8MA&ixlib=rb-4.1.0&q=80&w=1080)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Strategic social media management that grows your following, engages your audience,
                and drives real business results—not just vanity metrics.
              </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg text-gray-700 leading-relaxed">
              <span className="font-semibold text-[#1E3A5F]">
                With 20+ years of digital marketing experience since 2002
              </span>
              , we've managed social media campaigns that have generated over 10 million impressions
              for our clients. We were doing social media marketing before most platforms even
              existed.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4">
          <h2
            className="text-3xl font-bold text-center text-[#1E3A5F] mb-4"
            style={{ fontFamily: 'Playfair Display, serif' }}
          >
          ...
          <div className="grid md:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                step: '2',
                title: 'Strategy',
                desc: 'Custom plan aligned with your business goals',
              },
              {
                step: '3',
                title: 'Content',
                desc: 'Create engaging posts that reflect your brand',
              },
            ...
            >
                ...
                <div className="relative h-64">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A5F]/80 to-transparent flex items-end p-6">
                    <div className="text-white">
                      <h3 className="font-semibold text-xl mb-1">Content That Engages</h3>
              ...
              <Card className="overflow-hidden rounded-lg hover:shadow-xl transition-shadow duration-300">
                <div className="relative h-64">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A5F]/80 to-transparent flex items-end p-6">
                    <div className="text-white">
                      <h3 className="font-semibold text-xl mb-1">Multi-Platform Strategy</h3>
                      <p className="text-white/90 text-sm">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#00B4D8] rounded-2xl p-8 text-white relative">
              ...
              <blockquote className="text-xl italic mb-6">
                "ThinkMents transformed our social media presence. Our engagement increased by 200%
                and we're now getting quality leads directly from Instagram and Facebook. They truly
                understand how to make social media work for business."
              </blockquote>
      ...
      <RelatedServices
        services={[
          ...
          },
          {
            ...
            description:
              'Professional video production and photography services that tell your brand story.',
          ...
          },
          {
            ...
            description:
              'Strategic ad campaigns across Google, YouTube, and job boards with measurable ROI.',
