...
export default function ResourcesPage() {
  ...
  const categories = [
    {
      ...
      description:
        'Guides to improving your search rankings, from beginner basics to advanced strategies. Learn keyword research, on-page optimization, link building, local SEO, and technical SEO fundamentals.',
      link: '/marketing-seo',
    },
    {
      icon: Star,
      ...
      description:
        'Everything you need to optimize your Google Business Profile and dominate local search. Setup guides, optimization checklists, review strategies, and posting best practices.',
    ...
    },
    {
      ...
      description:
        'Resources for building and improving your website. Design principles, development best practices, speed optimization, and user experience guidelines.',
    ...
    },
    {
      ...
      description:
        'Guides to running effective ad campaigns on Google, Facebook, Instagram, and other platforms. Budget planning, targeting strategies, ad creation, and optimization tips.',
    ...
    },
    {
      ...
      description:
        'Strategies for building your social presence and engaging your audience. Platform-specific guides, content calendars, and engagement tactics.',
      link: '/social-media',
    },
    {
      icon: FileText,
      ...
      description:
        'Resources for creating content that attracts and converts customers. Blog writing guides, content strategy frameworks, and editorial calendar templates.',
  ...
  const featuredResources = [
    {
      ...
      description:
        'A comprehensive introduction to search engine optimization for business owners. Learn the fundamentals of how search works and what you can do to improve visibility.',
    },
    {
      title: 'Google Business Profile Optimization Checklist',
      description:
        'Step-by-step checklist to ensure your GBP is fully optimized. Covers every field, setting, and best practice for maximum local visibility.',
    },
    {
      title: 'Website Performance Audit Guide',
      description:
        "Learn how to evaluate your website's speed, mobile-friendliness, and technical health. Includes tools and benchmarks for assessment.",
    },
    {
      title: 'Content Calendar Template',
      description:
        'Downloadable template for planning your content marketing. Organize blog posts, social media, and campaigns in one place.',
    },
    {
      title: 'Local SEO Checklist',
      description:
        'Complete checklist for optimizing your business for local search. Covers website optimization, citations, reviews, and local content.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes. All guides, templates, tools, and educational content are completely free. We believe in providing value and building relationships.',
    },
    {
      question: 'How often do you add new resources?',
      answer:
        'We regularly add new content based on industry changes, common client questions, and emerging topics. Check back often or subscribe to our newsletter for updates.',
    },
    {
      question: 'Can I share your resources with others?',
      answer:
        'Absolutely! We encourage sharing. Just please credit ThinkMents and link back to the original resource.',
    },
    {
      question: "I have a question that's not covered in your resources. Can I ask?",
      answer:
        "Of course. Contact us with your question and we'll do our best to help—or point you toward resources that can.",
    },
    {
      question: 'Do you offer more in-depth help beyond these resources?',
      answer:
        'Yes. If you need personalized guidance or implementation help, our services and consulting can take you further.',
    },
  ];
  ...
  return (
    <>
      ...
      <section
        ref={heroRef}
        className="relative py-16 md:py-32 px-4 overflow-hidden bg-gradient-to-br from-[#1E3A5F] via-[#1E3A5F] to-[#0F2942]"
      >
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Knowledge is power—especially when it comes to growing your business online.{' '}
                <strong>
                  ThinkMents' Resource Center is your go-to destination for actionable digital
                  marketing insights, guides, templates, and tools.
                </strong>{' '}
                We've been helping businesses navigate the digital landscape since 2002, and we
                believe in sharing what we've learned. Whether you're looking to understand SEO
                basics, improve your social media strategy, or troubleshoot a technical issue, our
                resources are designed to help you succeed. Browse our collection of guides, tools,
                and educational content—all free and created by our team of experienced marketers.
              </p>
            </div>
          </motion.div>
        </div>
              ...
              {categories.map((category, idx) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <Link
                      to={category.link}
                      className="text-[#00B4D8] hover:underline text-sm flex items-center gap-1"
                    >
          ...
          >
              ...
              {[
                {
                  ...
                  description:
                    'Estimate the potential return on your digital marketing investment. Input your numbers and see projected results from SEO, PPC, and other channels.',
                },
                {
                  icon: Gauge,
                  title: 'Website Speed Test',
                  description:
                    'Check how fast your website loads and identify performance issues. Speed directly impacts user experience and search rankings.',
                },
                {
                  icon: Search,
                  title: 'SEO Audit Tool',
                  description:
                    "Quick assessment of your website's basic SEO health. Identifies common issues with titles, meta descriptions, and technical elements.",
                },
                {
                  icon: Star,
                  title: 'Review Link Generator',
                  description:
                    'Create a direct link to your Google review page. Make it easy for customers to leave reviews by sharing a simple link.',
                },
              ].map((tool, idx) => (
                <Card
                  key={idx}
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-xl text-[#1E3A5F] mb-4">
                We recommend these external tools as well:
              </h3>
        ...
        <div className="container mx-auto px-4">
          ...
          >
              ...
              {[
                {
                  ...
                  description:
                    "Start here if you're new to digital marketing. We explain concepts in plain English without jargon or assumptions about prior knowledge.",
                },
                {
                  title: 'How-To Tutorials',
                  description:
                    'Step-by-step instructions for specific tasks. Learn to set up Google Analytics, optimize a page for SEO, create effective ads, and more.',
                },
                {
                  title: 'Strategy Frameworks',
                  description:
                    'Conceptual guides that help you think strategically about marketing. Understand how channels work together and how to prioritize efforts.',
                },
                {
                  title: 'Industry Insights',
                  description:
                    'Stay current with changes in digital marketing. Algorithm updates, new platform features, and emerging trends explained.',
                },
              ].map((content, idx) => (
                <Card key={idx} className="hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6">
            ...
            <div className="mt-8 text-center bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-6">
              <p className="text-gray-700 mb-4">
                <strong>Learn from real examples.</strong> See how we've solved challenges for
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="mt-8 text-center">
              <Link
                to="/services"
                className="text-[#00B4D8] hover:underline flex items-center justify-center gap-1"
              >
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              ...
              <p className="text-lg text-white/90 leading-relaxed mb-6">
                Don't see what you're looking for? Let us know what topics, guides, or tools would
                be helpful for your business. We're constantly creating new resources based on what
                our community needs.
              </p>
        ...
        <div className="container mx-auto max-w-4xl relative z-10 px-4">
          ...
          >
            ...
            <p className="text-xl text-white/95 mb-8">
              Get the latest digital marketing tips, guides, and industry updates delivered to your
              inbox
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Some agencies guard their knowledge like trade secrets. We take a different
                approach.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mt-6">
                <strong>
                  Our resources reflect over 20 years of experience helping businesses grow.
                </strong>{' '}
                We hope they help you—whether you ever become a client or not.
              </p>
            </div>
          </motion.div>
        </div>
