...
export default function GoogleBusinessProfilePage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Reviews are the lifeblood of local search success. We implement systematic review generation strategies that encourage satisfied customers to share their experiences. This includes post-service follow-up sequences, easy review links, and staff training on appropriate review requests. We also monitor all reviews and craft professional responses to both positive and negative feedback, showing potential customers you care about customer satisfaction.',
      price: 'From $250/mo',
    },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        'The Questions & Answers section of your GBP is often overlooked but critical. We monitor incoming questions, provide helpful answers, and proactively seed your profile with common questions and optimized answers. This builds trust with potential customers and provides another opportunity to incorporate relevant keywords. We ensure your Q&A section works for you, not against you.',
    ...
    },
    {
      ...
      description:
        'Managing multiple locations? We handle them all with consistent branding and optimization while customizing each listing for its specific market. Our bulk management tools allow efficient updates across all locations while maintaining local relevance. We ensure consistent NAP (Name, Address, Phone) information, category selection, and photo standards across your entire portfolio. Perfect for franchises, chains, and multi-location service businesses.',
    ...
    },
    {
      ...
      description:
        "Struggling with Google's video verification? We guide you through the entire process with step-by-step instructions, example videos, and best practices. We help you prepare your verification video, ensure it meets Google's requirements, and troubleshoot any issues. For businesses that have failed video verification multiple times, we provide specialized consulting to identify and fix the underlying issues.",
      price: 'From $150',
    },
    {
      icon: FileText,
    ...
    },
    {
      ...
      description:
        "Understanding your competitive landscape is crucial. We analyze your top competitors' GBP profiles, identify what they're doing well, find opportunities to differentiate, and develop strategies to outperform them in local search results. We monitor competitors' review velocity, post frequency, category selections, and rankings to ensure you stay ahead. Knowledge is power in local SEO.",
      price: 'From $300',
    },
    {
      icon: GraduationCap,
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1559989899-f0743fa80152?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnb29nbGUlMjBidXNpbmVzcyUyMHByb2ZpbGUlMjBwaG9uZXxlbnwxfHx8fDE3NjU0MDA5NTZ8MA&ixlib=rb-4.1.0&q=80&w=1080)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Your GBP is often the first thing customers see. We handle everything—setup,
                verification, optimization, posting, reviews, and even suspension recovery.
              </p>
      ...
      <section ref={experienceRef} className="py-20 bg-[#F8F9FA]">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="bg-white rounded-lg shadow-lg p-8 border-l-4 border-[#00B4D8]">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Your Google Business Profile is often the first thing potential customers see when
                searching for your business—and it might be the only thing they see before deciding
                to call or visit. ThinkMents has been managing Google Business Profiles since Google
                first launched the platform (originally Google Places, then Google My Business, now
                Google Business Profile). With over 20 years of local marketing experience, we
                understand exactly how to optimize your profile to appear in the coveted Local
                3-Pack, generate more calls, and turn searchers into customers. We've managed
                hundreds of GBP listings across 31 states, helping businesses dominate local search
                results.
              </p>
            </div>
          </motion.div>
          ...
          >
            <h2
              className="text-4xl md:text-5xl text-[#1E3A5F] mb-4"
              style={{ fontFamily: 'Playfair Display, serif' }}
            >
              Comprehensive GBP Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From setup to suspension recovery, we handle every aspect of your Google Business
              Profile
            </p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/90">
                    of consumers who search locally on mobile visit or call within 24 hours
                  </p>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-[#00B4D8] mb-2">70%</div>
                  <p className="text-white/90">
                    more likely to attract visits with a complete GBP listing
                  </p>
                </div>
                <div className="text-center">
                ...
                <Card className="h-full border-2 border-[#00B4D8]/20 hover:border-[#00B4D8] transition-all duration-300 hover:shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      The Google Local 3-Pack appears in <strong>93% of searches</strong> with local
                      intent
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-[#F7B928]/20 hover:border-[#F7B928] transition-all duration-300 hover:shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg">
                      <strong>5-star rated businesses get 25% more clicks</strong> than 3-star
                      businesses
                    </p>
                  </CardContent>
                </Card>
            ...
            >
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                If you're not appearing in Google's local results,{' '}
                <strong>
                  you're invisible to customers actively searching for your services right now.
                </strong>{' '}
                Your competitors are getting those calls instead.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Google Business Profile is free to use, but optimization requires expertise.{' '}
                <strong>
                  The difference between a basic listing and a fully optimized profile can mean
                  dozens of additional calls and customers every month.
                </strong>
              </p>
            </motion.div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Plumbers, electricians, HVAC, home services that rely on "near me" searches and
                    local visibility.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Healthcare providers where GBP visibility directly impacts new patient
                    acquisition.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Franchises and chains needing coordinated GBP management across dozens or
              ...
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Law firms and professional services where GBP reviews build trust and
                    credibility.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Businesses where location, hours, photos, and reviews directly drive foot
                    traffic.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Companies with suspended profiles, duplicate listings, negative reviews, or
        ...
        services={[
          {
            ...
            description:
              'Protect and enhance your online reputation with proactive monitoring and strategic review management.',
