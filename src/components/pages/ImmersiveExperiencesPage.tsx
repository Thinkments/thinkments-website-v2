  ...
  const faqs = [
    {
      ...
      answer: 'Pricing depends on property size and complexity. Basic virtual tours start around $300-500 for small spaces, with larger or more complex projects ranging from $800-2,500+. We provide custom quotes after understanding your specific needs.'
    },
    {
      question: 'How long does production take?',
      answer: 'Most virtual tours are completed within 1-2 weeks from the capture date. Larger projects or those requiring extensive post-production may take longer.'
    },
    {
      question: 'Do I own the virtual tour?',
      answer: 'Yes. You receive full usage rights for all content we produce. Tours remain accessible as long as you maintain hosting (we offer affordable annual hosting plans).'
    },
    {
      question: 'Can virtual tours be updated?',
      answer: 'Yes. If your space changes significantly, we can recapture and update the tour. Minor changes can sometimes be addressed without a full reshoot.'
    },
    {
      question: 'How do customers view the tour?',
      answer: 'Tours work on any device—smartphones, tablets, laptops, and desktops. No special software or app is required. VR headset viewing is also supported for maximum immersion.'
    },
    {
      question: 'Will the tour work on my website?',
      answer: 'Absolutely. We provide embed codes that work with any website platform. Tours are responsive and mobile-friendly.'
    },
    {
      question: 'Do you travel for captures?',
      answer: 'Yes. While we\'re based in Texas, we travel for projects throughout the region and can accommodate projects nationwide for larger engagements.'
    }
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1634814251396-479adacfc527?w=1080&fit=crop)',
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Step into the future of visual marketing with immersive experiences that captivate your audience and set your business apart
              </p>
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Step into the future of visual marketing with immersive experiences that captivate your audience and set your business apart. <strong>ThinkMents has been pioneering immersive technology since the early days of virtual tours—we created the first virtual real estate tour in North Texas and built the first arena seat preview system with Mark Cuban's American Airlines Center.</strong> With over 20 years of innovation in visual technology, we understand how to leverage virtual tours, 360° photography, and interactive experiences to engage customers, showcase properties, and drive real business results. While competitors are just discovering these technologies, we've been perfecting them for decades.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Listings with virtual tours receive more views than those without</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Virtual tours increase time on website compared to static images</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">of people want more businesses to offer virtual tours</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Properties with 3D tours sell faster and for higher prices</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">360° content generates more engagement on social media</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                <strong>Today's customers expect to explore before they visit.</strong> Whether they're choosing a restaurant, previewing a hotel room, touring a home, or evaluating a venue, they want to experience it virtually first. Businesses without immersive content are losing customers to competitors who offer this modern experience.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Immersive experiences also dramatically extend your geographic reach—<strong>customers from anywhere in the world can 'visit' your location</strong>, breaking down distance barriers that limit traditional marketing.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section ref={industriesRef} className="py-20 bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Virtual tours have become essential for property marketing. Buyers tour homes remotely, filtering before in-person visits. Sellers attract more qualified buyers and sell faster with 3D tours.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Let guests explore rooms, amenities, and common areas before booking. Hotels with virtual tours see higher booking conversion rates and reduced 'surprise' complaints.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Showcase your atmosphere, seating options, and event spaces. Customers choosing venues for weddings, parties, and corporate events want to see the space before committing.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Let customers browse your showroom virtually. Perfect for furniture stores, boutiques, and specialty retailers where the in-store experience matters.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Families researching senior living facilities or healthcare providers appreciate virtual tours that reduce the stress of in-person facility visits.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Campus tours reach prospective students worldwide. Universities and private schools use virtual tours as recruiting tools.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Extend your reach beyond physical visitors. Virtual tours can also serve as accessibility accommodations for those unable to visit in person.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Document project progress with regular 360° captures. Create 'before and after' comparisons and pre-sell spaces before completion.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
                ...
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-700">Site assessment to plan capture strategy</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
                      <span className="text-gray-700">Define hotspots and interactive elements</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
                      <span className="text-gray-700">Multiple heights and angles for completeness</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
            ...
            <div className="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-l-[#FF6B35]">
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>Most projects complete within 1-2 weeks from capture to delivery</strong>, depending on complexity and property size.
              </p>
            </div>
          </motion.div>
        </div>
              ...
              <CardContent className="p-8">
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700 text-lg">Insta360 Pro 2 and Ricoh Theta Z1 for 360° capture</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <span className="text-gray-700 text-lg">Matterport Pro2 and Pro3 cameras for 3D scanning</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <span className="text-gray-700 text-lg">Professional lighting for interior shoots</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <span className="text-gray-700 text-lg">DJI commercial drones for aerial capture</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <span className="text-gray-700 text-lg">High-performance processing workstations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <span className="text-gray-700 text-lg">Enterprise hosting for reliable delivery</span>
                  </li>
                </ul>

                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-lg text-gray-700 leading-relaxed">
                    <strong>Our technology investment means your virtual tours match the quality of your business</strong>—not amateur-looking captures that undermine your brand.
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                ThinkMents isn't new to immersive technology—we've been creating virtual experiences since before the technology went mainstream
              </p>
            </div>
            ...
            <div className="space-y-6">
              <Card className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-xl text-[#1E3A5F] mb-3">First Virtual Real Estate Tour in North Texas</h3>
                  <p className="text-gray-700 leading-relaxed">
                    We produced the region's first virtual property tour, revolutionizing how real estate was marketed locally.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-xl text-[#1E3A5F] mb-3">American Airlines Center Seat Preview System</h3>
                  <p className="text-gray-700 leading-relaxed">
                    Working with Mark Cuban's team, we created the first arena seat preview system, allowing fans to see their view before purchasing tickets.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We became Google Street View trusted photographers when interior capture was first introduced.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    While other agencies are just discovering virtual tours, we've been refining our techniques, testing new technologies, and perfecting the customer experience for over 20 years.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-[#00B4D8] to-[#1E3A5F] text-white rounded-lg shadow-lg p-8">
              <p className="text-xl leading-relaxed text-center">
                <strong>This experience translates into better results for you—we've already learned the lessons that newer providers are still figuring out.</strong>
              </p>
            </div>
          </motion.div>
        </div>
