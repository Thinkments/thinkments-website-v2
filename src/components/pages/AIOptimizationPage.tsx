  ...
  const benefits = [
    {
      ...
      description: 'Automate tasks that previously took hours, freeing your team to focus on high-value strategic work'
    },
    {
      icon: DollarSign,
      title: 'Cost Reduction',
      description: 'Lower operational costs by 30-50% through intelligent automation and reduced manual labor'
    },
    {
      icon: Zap,
      title: '24/7 Operations',
      description: 'AI systems work around the clock without breaks, ensuring continuous customer service and operations'
    },
    {
      icon: CheckCircle,
  ...
  const processSteps = [
    {
      ...
      description: 'We analyze your current operations, identify automation opportunities, and calculate potential ROI'
    },
    {
      number: '2',
  ...
  const faqs = [
    {
      ...
      answer: 'Simple automations can be live within 1-2 weeks. More complex integrations typically take 4-8 weeks. We always start with quick-win projects so you see value fast.'
    },
    {
      question: 'Is AI optimization expensive?',
      answer: 'Costs vary based on complexity, but most AI solutions pay for themselves within 2-3 months through time savings and efficiency gains. We offer solutions for businesses of all sizes.'
    },
    {
      question: 'Will AI replace my employees?',
      answer: 'No. AI is designed to augment your team, not replace them. It handles repetitive tasks so your people can focus on creative, strategic, and relationship-building work that requires human judgment.'
    },
    {
      question: 'What if AI makes mistakes?',
      answer: 'We implement quality checks, human review processes, and continuous monitoring. AI systems improve over time and we fine-tune them based on your feedback and results.'
    },
    {
      question: 'Do I need technical expertise to use AI tools?',
      answer: 'No. We handle all the technical setup and provide training so your team can use AI tools confidently. Our solutions are designed to be user-friendly.'
    }
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1080&fit=crop)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Transform your business operations with artificial intelligence and automation. Reduce costs, increase efficiency, and gain competitive advantages with proven AI solutions.
              </p>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  With over 20 years of digital innovation experience since 2002, ThinkMents has been at the forefront of AI and automation technology. We started exploring machine learning and automation tools years before they became mainstream, giving us deep expertise in implementing AI solutions that deliver real business results. Our team has deployed AI optimization strategies for businesses across 31 states, helping them automate workflows, reduce costs, and gain competitive advantages.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/analytics-reporting" className="text-[#00B4D8] hover:text-[#1E3A5F] font-semibold underline">
                Analytics & Reporting
              </Link>
              ...
              >
                <div className="flex gap-6">
                  ...
                  <div className="flex-1 pb-8">
                    <h3 className="font-semibold text-[#1E3A5F] text-xl mb-2">
                      {step.title}
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      {step.description}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Schedule a free AI assessment and discover how automation can reduce costs, save time, and give you a competitive advantage.
            </p>
