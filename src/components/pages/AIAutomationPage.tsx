  ...
  const services = [
    {
      ...
      description:
        'High-quality content created with AI assistance. Blog posts, social content, and more.',
    ...
    },
    {
      ...
      description:
        'AI chatbots that answer customer questions, capture leads, and book appointments 24/7.',
      price: 'From $500',
      badge: null,
    },
    {
      ...
      description:
        'Automate repetitive tasks. Lead routing, email sequences, data entry, and more.',
    ...
    },
    {
      ...
      description:
        "Create searchable knowledge bases from your documents using Google's NotebookLM.",
      price: 'From $250',
      badge: null,
    },
    {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1717501219263-9aa2d6a768d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnRpZmljaWFsJTIwaW50ZWxsaWdlbmNlJTIwbmV1cmFsJTIwbmV0d29ya3xlbnwxfHx8fDE3NjUzODgyNjZ8MA&ixlib=rb-4.1.0&q=80&w=1080)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                The future of marketing is here. We&apos;re integrating AI tools to automate tedious
                tasks, generate better content, and optimize for the next generation of search
                engines.
              </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg text-gray-700 leading-relaxed">
              <span className="font-semibold text-[#1E3A5F]">
                ThinkMents has been at the forefront of digital innovation since 2002.
              </span>
              We started exploring AI and automation tools years before ChatGPT made headlines,
              applying cutting-edge technology to solve real business problems. Our 20+ years of
              experience means we know how to implement AI that actually works for your business.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
            {[
              { icon: Search, title: 'Assessment', desc: 'Identify automation opportunities' },
              {
                ...
                desc: 'Custom AI strategy for your needs',
              },
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A5F]/90 to-transparent flex items-end p-6">
                  <div className="text-white">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-semibold text-xl">Automation in Action</h3>
                    </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A5F]/90 to-transparent flex items-end p-6">
                  <div className="text-white">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-semibold text-xl">24/7 AI Support</h3>
                    </div>
                    <p className="text-white/90 text-sm">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#00B4D8] rounded-2xl p-8 text-white">
              ...
              <blockquote className="text-xl italic mb-6">
                "ThinkMents implemented AI automation that saves us 20+ hours per week. They didn't
                just set it up - they trained our team and made sure it actually worked for our
                specific needs. The ROI has been incredible."
              </blockquote>
              <div>
        ...
        services={[
          {
            ...
            description:
              'Track performance with comprehensive analytics dashboards and automated reporting.',
