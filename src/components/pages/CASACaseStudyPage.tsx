          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="text-xl md:text-2xl leading-relaxed text-center text-muted-foreground">
                CASA—Court Appointed Special Advocates—fights for the most vulnerable children in our community: those who have been abused, neglected, or abandoned. Their volunteer advocates become the voice for children in court who have no one else. But when CASA's California-based web company became unresponsive and left them with a slow, broken website and at-risk email system, their ability to recruit volunteers and connect with donors was in jeopardy. Every day the website was down or broken,{' '}
                <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                  children who needed advocates weren't getting them
                </span>
                . ThinkMents executed a complete digital rescue—rebuilding their web presence, migrating their email to a secure platform, and providing the local support they should have had all along.
              </p>
            </motion.div>
          </div>
        </div>
              ...
              <Card className="bg-gradient-to-br from-muted/30 to-background border-primary/20">
                <CardContent className="p-8">
                  ...
                  <ul className="space-y-4">
                    {[
                      { title: 'Unresponsive vendor', desc: 'Emails and calls went unanswered for weeks' },
                      { title: 'Slow, broken website', desc: 'Pages took forever to load, forms didn\'t work, content was outdated' },
                      { title: 'No local support', desc: 'When issues arose, there was no one to call who could help quickly' },
                      { title: 'Email at risk', desc: 'Their email system was hosted on the same unreliable server' },
                      { title: 'Security concerns', desc: 'Outdated platform with unknown vulnerabilities' },
                      { title: 'No backups they controlled', desc: 'If something went wrong, they had no safety net' },
                      { title: 'Difficult to update', desc: 'Staff couldn\'t make simple changes without vendor help (who wouldn\'t respond)' },
                      { title: 'Unprofessional appearance', desc: 'The broken site reflected poorly on the organization' },
                      { title: 'Lost opportunities', desc: 'Potential volunteers and donors left the site frustrated' }
                    ].map((item, index) => (
                      <motion.li
                        key={index}
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {[
                        { title: 'Volunteer recruitment', desc: 'Most volunteers discover CASA online' },
                        { title: 'Donor engagement', desc: 'Fundraising increasingly happens digitally' },
                        { title: 'Community awareness', desc: 'People can\'t support what they don\'t know exists' },
                        { title: 'Resource access', desc: 'Families in crisis search online for help' },
                        { title: 'Professional credibility', desc: 'Courts, schools, and agencies check the website' }
                      ].map((item, index) => (
                        <li key={index} className="flex items-start space-x-2">
                ...
                <CardContent className="p-0">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody>
                        {[
                          { aspect: 'Website Speed', before: 'Extremely slow', after: 'Fast, modern' },
                          { aspect: 'Uptime', before: 'Unreliable, frequent issues', after: '100% uptime' },
                          { aspect: 'Email Reliability', before: 'At-risk, same bad server', after: 'Google Workspace secure' },
                          { aspect: 'Vendor Response', before: 'Weeks or never', after: 'Same day' },
                          { aspect: 'Location', before: 'California (different time zone)', after: 'Decatur, Texas (local)' },
                          { aspect: 'Updates', before: 'Nearly impossible', after: 'Staff can do themselves' },
                          { aspect: 'Security', before: 'Unknown, outdated', after: 'Modern, monitored' },
                          { aspect: 'Backups', before: 'None they controlled', after: 'Automated, accessible' },
                          { aspect: 'Volunteer Signups', before: 'Broken forms', after: 'Smooth process' },
                          { aspect: 'Donations', before: 'Friction-filled', after: 'Simple and working' }
                        ].map((row, index) => (
                          <motion.tr
                            key={index}
                          ...
                          >
                            ...
                            <td className="p-6 text-center text-muted-foreground">{row.before}</td>
              ...
              {[
                {
                  ...
                  description: 'We didn\'t treat this as a normal project with a leisurely timeline. CASA\'s mission was being compromised every day. We moved fast because children were counting on it.',
                  icon: Zap
                },
                {
                  number: '2',
                  title: 'Complete solution, not a band-aid',
                  description: 'We didn\'t just fix the website and leave the vulnerable email system in place. We addressed everything—web, email, hosting, security, support—so CASA wouldn\'t face this situation again.',
                  icon: Shield
                },
                {
                  number: '3',
                  title: 'Local partnership over distant vendor',
                  description: 'The California company saw CASA as one small account among many. We see them as neighbors serving our community\'s children. That difference matters in how we respond, how we communicate, and how we care about the outcome.',
                  icon: MapPin
                }
              ].map((factor, index) => (
                <motion.div
              ...
              <Card className="bg-gradient-to-br from-muted/30 to-background border-primary/20">
                <CardContent className="p-8">
                  <p className="text-xl leading-relaxed text-center">
                    ...
                    <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                      This is why ThinkMents prioritizes nonprofit clients. The work they do matters too much to be undermined by bad technology.
                    </span>
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
                <CardContent className="p-8">
                  <p className="text-lg leading-relaxed text-center">
                    Every technical fix we made connects back to a child in the court system who now has a better chance at a{' '}
                    <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                      safe, permanent home
                    </span>
                    .
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Card className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 border-orange-500/30">
                <CardHeader>
                  <CardTitle className="text-2xl">Warning signs you might need a rescue:</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3">
                    {[
