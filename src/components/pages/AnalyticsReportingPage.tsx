...
export default function AnalyticsReportingPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Clear, actionable reports showing what's working and recommendations for improvement.",
      price: 'From $200/mo',
      badge: null,
    },
    {
    ...
    },
    {
      ...
      title: 'ROI Analysis',
      description:
        'Connect marketing spend to actual revenue. Know your true return on investment.',
      price: 'From $350',
      badge: null,
    },
  ];
  ...
  const trackingItems = [
    ...
    },
    {
      ...
      description:
        'Understand what pages users visit, how long they stay, and where they drop off.',
    },
  ];
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhbmFseXRpY3MlMjBkYXNoYm9hcmQlMjBncmFwaHMlMjBjaGFydHN8ZW58MXx8fHwxNzY1NDAyNTgyfDA&ixlib=rb-4.1.0&q=80&w=1080)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Stop guessing and start knowing. We set up proper tracking, build custom dashboards,
                and deliver reports that actually tell you what&apos;s working and what&apos;s not.
              </p>
      ...
      <section className="py-12 bg-gradient-to-r from-[#1E3A5F]/5 to-[#00B4D8]/5">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <p className="text-lg text-gray-700">
            <span className="font-semibold text-[#1E3A5F]">For over 20 years</span>, we've helped
            businesses make data-driven decisions. We've analyzed millions of data points across
            hundreds of campaigns to uncover insights that drive real growth. Our reporting doesn't
            just show numbers—it tells you what to do next.
          </p>
        </div>
      </section>
                  ...
                  <div className="relative h-64">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A5F]/80 to-transparent flex items-end p-6">
                      <div className="text-white">
                        <h3 className="font-semibold text-xl mb-1">Visual Dashboards</h3>
              ...
              >
                <Card className="overflow-hidden rounded-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="relative h-64">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A5F]/80 to-transparent flex items-end p-6">
                      <div className="text-white">
                        <h3 className="font-semibold text-xl mb-1">Actionable Insights</h3>
                        <p className="text-white/90 text-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-[#1E3A5F] to-[#00B4D8] rounded-2xl p-8 text-white">
            ...
            <blockquote className="text-xl italic mb-6">
              "Finally, reports I can actually understand and act on! ThinkMents doesn't just dump
              data on us—they explain what it means and what we should do. Our marketing ROI has
              improved 340% since we started working with them."
            </blockquote>
              ...
              {[
                {
                  ...
                  description:
                    'Our team is certified in Google Analytics 4 and stays current with all platform updates.',
                },
                {
                  title: '100% Data Accuracy',
                  description:
                    'We implement tracking correctly from the start, so you can trust your data.',
                },
                {
                  title: 'Custom Dashboards',
                  description:
                    'Real-time dashboards built around your specific business goals and KPIs.',
                },
                {
                  title: 'Clear, Actionable Reports',
                  description:
                    'No jargon. Just clear explanations of what the data means and what to do about it.',
                },
                {
                  title: 'ROI Focused',
                  description:
                    "We connect your marketing spend directly to revenue so you know what's working.",
                },
                {
                  title: 'Ongoing Optimization',
                  description:
                    'Monthly reports include recommendations for improvement based on data trends.',
                },
              ].map((benefit, idx) => (
                <motion.div
                  key={idx}
      ...
      <RelatedServices
        services={[
          ...
          },
          {
            ...
            description:
              'Technical support including DNS, email configuration, SSL, security, and server management.',
