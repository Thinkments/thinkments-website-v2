...
export default function TechnicalServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Changing domains, platforms, or hosts is risky—but sometimes necessary. We manage website migrations that preserve your SEO equity, maintain functionality, and minimize downtime. Our migration process includes comprehensive redirect mapping, content verification, technical testing, and post-migration monitoring. We\'ve successfully migrated sites without traffic loss when others predicted disaster.'
    },
    {
      icon: Plug,
      title: 'API Integrations & Development',
      description: 'Connect your website with the tools and platforms that power your business. We develop custom API integrations linking your website to CRMs, marketing automation platforms, payment processors, inventory systems, and third-party services. Our integrations automate workflows, eliminate manual data entry, and create seamless experiences for your customers and team.'
    },
    {
      icon: Code,
      title: 'Custom Development & Functionality',
      description: 'When off-the-shelf solutions don\'t fit your needs, we build custom functionality. Our development team creates calculators, configurators, booking systems, member portals, custom forms, and specialized features that differentiate your business. We develop solutions that work within your existing platform or as standalone applications.'
    },
    {
      icon: Settings,
      title: 'Website Maintenance & Support',
      description: 'Keep your website secure, updated, and performing optimally without the hassle. Our maintenance services include software updates, security monitoring, daily backups, uptime monitoring, performance optimization, and priority support. We handle the technical details so you can focus on running your business.'
    },
    {
      icon: Server,
  ...
  const faqs = [
    {
      ...
      answer: 'Technical audits typically range from $500-2,000. Ongoing maintenance plans start at $200/month. Custom development and complex projects are quoted based on scope.'
    },
    {
      question: 'How quickly can you respond to emergencies?',
      answer: 'For maintenance clients, we provide same-day response for critical issues. Non-emergency requests are typically addressed within 24-48 hours.'
    },
    {
      question: 'Do you work with all website platforms?',
      answer: 'We have deep expertise in WordPress and React-based sites. We also work with Shopify, Webflow, and custom platforms. We\'ll let you know if a platform is outside our expertise.'
    },
    {
      question: 'Can you help if our site has been hacked?',
      answer: 'Yes. We provide emergency malware removal and site recovery services. We clean the infection, identify how it happened, and implement protections to prevent recurrence.'
    },
    {
      question: 'Do you offer website hosting?',
      answer: 'We recommend and help configure hosting but don\'t operate our own data centers. We can manage your hosting environment regardless of provider.'
    },
    {
      question: 'What\'s included in maintenance plans?',
      answer: 'Core inclusions are software updates, security monitoring, daily backups, uptime monitoring, and support hours. Plans are customized based on your site\'s complexity and needs.'
    },
    {
      question: 'Can you improve our page speed?',
      answer: 'Almost always. We consistently achieve 40-70% improvements in load times. We\'ll assess your site and provide realistic expectations before starting.'
    }
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1080&fit=crop)',
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Behind every great website and digital marketing campaign is a solid technical foundation. <strong>ThinkMents' Technical Services ensure your digital infrastructure performs flawlessly—fast, secure, reliable, and optimized for both users and search engines.</strong> Since 2002, we've been solving complex technical challenges that other agencies can't handle. Our team combines deep technical expertise with marketing knowledge, understanding that technical decisions directly impact business results. Whether you need a performance audit, security hardening, complex integrations, or ongoing technical support, we have the skills to keep your digital presence running smoothly.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                You can have the best marketing strategy in the world, but if your website is slow, insecure, or unreliable, you're throwing money away. <strong>Technical problems frustrate users, hurt search rankings, and undermine trust.</strong>
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Most agencies focus only on surface-level marketing. ThinkMents goes deeper—ensuring the technical foundation supports and amplifies your marketing investment.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>Our technical services aren't just about fixing problems. They're about creating competitive advantage through superior digital infrastructure that loads faster, converts better, and ranks higher than your competitors.</strong>
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section ref={auditRef} className="py-20 bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
              ...
              {[
                {
                  ...
                  items: ['Page speed testing across devices', 'Core Web Vitals assessment (LCP, FID, CLS)', 'Server response time analysis', 'Resource loading optimization', 'Third-party script impact']
                },
                {
                  title: 'Security Assessment',
                  items: ['Vulnerability scanning', 'SSL/TLS configuration review', 'Authentication and access controls', 'Data protection practices', 'Plugin and software currency']
                },
                {
                  title: 'Technical SEO Review',
                  items: ['Crawlability and indexation', 'Site architecture evaluation', 'URL structure assessment', 'Redirect chain identification', 'Structured data validation', 'Mobile usability testing']
                },
                {
                  title: 'Infrastructure Evaluation',
                  items: ['Hosting environment assessment', 'Backup and recovery capabilities', 'Uptime history review', 'Scalability considerations']
                }
              ].map((section, idx) => (
            ...
            <div className="mt-8 bg-[#FF6B35] rounded-lg p-6">
              <p className="text-white text-lg leading-relaxed text-center">
                <strong>You receive a detailed report with prioritized recommendations, expected impact, and implementation guidance.</strong> We can then implement fixes ourselves or guide your team through the process.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { title: 'Largest Contentful Paint (LCP)', description: 'How quickly the main content loads. Target: under 2.5 seconds.' },
                { title: 'First Input Delay (FID)', description: 'How quickly the page responds to user interaction. Target: under 100 milliseconds.' },
                { title: 'Cumulative Layout Shift (CLS)', description: 'How much the page layout shifts during loading. Target: under 0.1.' }
              ].map((metric, idx) => (
            ...
            <div className="mt-8 bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Many websites fail these benchmarks—and pay the price in search rankings and user experience.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>Passing Core Web Vitals isn't just about pleasing Google—it's about providing the fast, stable experience users expect.</strong>
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  title: 'Prevention',
                  items: ['SSL/TLS encryption', 'Web application firewall (WAF)', 'Brute force protection', 'File integrity monitoring', 'Security headers', 'Regular updates']
                },
                {
                  title: 'Detection',
                  items: ['24/7 malware scanning', 'Suspicious activity monitoring', 'Unauthorized change detection', 'Vulnerability identification']
                },
                {
                  title: 'Response',
                  items: ['Rapid incident response', 'Malware removal and cleanup', 'Blacklist removal assistance', 'Post-incident hardening']
                }
              ].map((category, idx) => (
            ...
            <div className="mt-8 bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed">
                For businesses handling sensitive data—healthcare, legal, financial—we ensure compliance with relevant security standards. <strong>Security isn't a one-time project. Our ongoing monitoring keeps your defenses current against evolving threats.</strong>
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section ref={problemsRef} className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: 'Slow Loading Websites', description: 'Bloated images, inefficient code, poor hosting, unoptimized databases—we identify and eliminate speed bottlenecks.' },
                { title: 'Hacked Websites', description: 'Malware infections, defacements, spam injections—we clean compromised sites and prevent reinfection.' },
                { title: 'SEO Visibility Problems', description: 'Crawl errors, indexation issues, broken redirects, duplicate content—we fix technical SEO problems that tank rankings.' },
                { title: 'Broken Functionality', description: 'Forms that don\'t submit, integrations that stopped working, features that broke after updates—we diagnose and repair.' },
                { title: 'Mobile Problems', description: 'Sites that don\'t work on phones, responsive design failures, mobile speed issues—we make your site work everywhere.' },
                { title: 'Migration Disasters', description: 'Traffic drops after redesigns, lost pages, broken links—we recover from failed migrations and prevent future problems.' },
                { title: 'Plugin/Theme Conflicts', description: 'WordPress sites with mysterious errors caused by incompatible components—we untangle the mess.' }
              ].map((problem, idx) => (
                <Card key={idx} className="hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6">
            ...
            <div className="mt-8 text-center bg-white rounded-lg shadow-lg p-6">
              <p className="text-lg text-gray-700">
                <strong>If you have a technical problem, chances are we've solved it before.</strong>
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section ref={whyChooseRef} className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { title: '20+ Years Technical Experience', description: 'We\'ve been solving technical problems since dial-up internet. There\'s no challenge we haven\'t encountered.' },
                { title: 'Marketing-Aware Technical Team', description: 'We understand how technical decisions impact marketing results—a rare combination.' },
                { title: 'Responsive Support', description: 'When technical emergencies arise, we respond quickly. Your business can\'t wait days for help.' },
                { title: 'Transparent Communication', description: 'We explain technical issues in plain English and keep you informed throughout the process.' },
                { title: 'Long-Term Partnership', description: 'We\'re here for ongoing support, not just one-time fixes.' }
              ].map((reason, idx) => (
                <Card key={idx} className="hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6">
