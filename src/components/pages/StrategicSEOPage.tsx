  ...
  const faqs = [
    {
      ...
      answer: 'Our SEO services typically range from $1,500-$5,000+ per month depending on competition level, website size, and goals. We provide custom quotes based on your specific situation.'
    },
    {
      question: 'How long until we see results?',
      answer: 'Most clients see meaningful ranking improvements within 3-4 months, with significant traffic and lead growth by months 6-9. SEO is a long-term investment that compounds over time.'
    },
    {
      question: 'Do you guarantee rankings?',
      answer: 'No ethical SEO provider can guarantee specific rankings—Google\'s algorithm considers hundreds of factors outside anyone\'s control. We guarantee our effort, expertise, and proven processes that consistently deliver results.'
    },
    {
      question: 'What if we\'ve been penalized by Google?',
      answer: 'We conduct penalty assessments and recovery services. If your site has been penalized, we identify the cause, fix the issues, and submit reconsideration requests to restore your rankings.'
    },
    {
      question: 'Do you work with any industry?',
      answer: 'We\'ve delivered SEO results across dozens of industries including healthcare, legal, home services, e-commerce, professional services, and more. We research your specific industry before developing strategies.'
    },
    {
      question: 'Can we do SEO ourselves?',
      answer: 'Basic SEO is possible to DIY, but strategic SEO requires significant expertise and time investment. Most businesses find that professional SEO delivers better ROI than internal efforts.'
    },
    {
      question: 'How do you measure success?',
      answer: 'We track rankings, organic traffic, conversions, leads, and revenue attributed to organic search. Monthly reports show exactly how SEO is impacting your business.'
    }
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1432888622747-4eb9a8f2c293?w=1080&fit=crop)',
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                Build a sustainable competitive advantage that delivers qualified leads month after month, year after year
              </p>
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Search Engine Optimization isn't just about rankings—it's about building a sustainable competitive advantage that delivers qualified leads month after month, year after year. Strategic SEO goes beyond basic optimization tactics to create comprehensive search visibility that dominates your market. <strong>ThinkMents has been delivering strategic SEO results since 2002, long before Google became the dominant search engine it is today.</strong> With over two decades of experience navigating algorithm updates, industry shifts, and evolving best practices, we develop SEO strategies that stand the test of time. Our clients don't just rank—they dominate their markets with sustainable organic visibility that compounds over time.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-gradient-to-br from-[#00B4D8]/10 to-[#1E3A5F]/10 rounded-lg p-6 border-l-4 border-l-[#00B4D8]">
                  ...
                  <p className="text-gray-700 text-lg italic">"How do we capture maximum market share from organic search?"</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed pl-8">
                    Understanding your total addressable market in search—every keyword, question, and query your potential customers use throughout their buying journey.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed pl-8">
                    Analyzing where competitors are strong, where they're weak, and where opportunities exist to capture market share.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed pl-8">
                    Prioritizing efforts based on opportunity size, competition level, and business impact—not just search volume.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed pl-8">
                    Building SEO roadmaps that compound results over 12, 24, and 36 months rather than chasing quick wins that fade.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed pl-8">
                    Connecting SEO with content marketing, paid advertising, social media, and overall business strategy for maximum impact.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Card className="bg-gradient-to-r from-[#00B4D8] to-[#1E3A5F] text-white border-none">
              <CardContent className="p-8">
                <p className="text-xl leading-relaxed text-center">
                  <strong>Strategic SEO transforms search from a marketing tactic into a business growth engine.</strong>
                </p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 1: Discovery & Analysis (Weeks 1-3)</h3>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 2: Strategy Development (Weeks 3-4)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 3: Foundation Building (Months 1-3)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 4: Growth & Expansion (Months 4-8)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 5: Domination & Defense (Months 9-12+)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
            ...
            <div className="mt-8 bg-[#FF6B35] rounded-lg p-6">
              <p className="text-white text-lg leading-relaxed">
                <strong>Throughout this process, you receive monthly reports showing rankings, traffic, conversions, and ROI.</strong> We meet regularly to review progress and adjust strategies based on results and market changes.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="space-y-4">
              <Card className="border-l-4 border-l-gray-400">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Audits, fixes, strategy development. Traffic changes minimal.</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-blue-400">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Early ranking movements for lower-competition keywords. Traffic beginning to increase.</p>
                </CardContent>
              </Card>

              <Card className="border-l-4 border-l-[#00B4D8]">
                <CardContent className="p-6">
                  <h3 className="text-lg text-[#1E3A5F] mb-2">Month 5-6: Meaningful Improvements</h3>
                  <p className="text-gray-700">Meaningful ranking improvements for primary keywords. Noticeable traffic growth.</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-green-500">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Compounding results as authority builds. Significant traffic and lead increases.</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-[#FF6B35]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Strong rankings for competitive keywords. Substantial organic traffic and conversions.</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-yellow-500">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">Market domination. Defending positions while expanding into new opportunities.</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-l-red-500">
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>We set realistic expectations from day one.</strong> Agencies promising page-one rankings in 30 days are either lying or using tactics that will eventually backfire. Sustainable SEO success requires patience and consistent effort—but the results are worth waiting for.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <Card className="border-t-4 border-t-[#00B4D8] text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">of users ignore paid ads, focusing on organic results</p>
                </CardContent>
              </Card>
            ...
            <div className="bg-gradient-to-r from-[#00B4D8] to-[#1E3A5F] text-white rounded-lg shadow-lg p-8">
              <p className="text-lg leading-relaxed mb-4">
                The ROI of SEO typically exceeds other marketing channels because you're capturing demand that already exists—people actively searching for what you offer. Unlike interruption-based marketing, SEO connects you with customers at the moment of intent.
              </p>
              <p className="text-lg leading-relaxed">
                <strong>Strategic SEO builds an asset that appreciates over time, delivering increasing returns on your initial investment.</strong>
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <div className="space-y-6">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We've practiced SEO since before Google was dominant—through every algorithm update, industry shift, and best practice evolution. This experience means we know what works long-term.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    No black boxes or mysterious tactics. You understand exactly what we're doing and why. Full access to data, regular communication, and clear reporting.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We care about leads and revenue, not just rankings. Our strategies prioritize keywords and content that drive actual business results.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    No shortcuts, no risky tactics, no purchased links. Our methods build sustainable rankings that don't disappear with the next algorithm update.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Case studies and testimonials from businesses across industries demonstrate our ability to deliver measurable SEO results.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Let's develop an SEO strategy that dominates your market and delivers sustainable results.
            </p>
