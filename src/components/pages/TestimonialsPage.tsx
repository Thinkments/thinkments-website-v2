...
export default function TestimonialsPage() {
  ...
  const testimonials: Testimonial[] = [
    {
      id: 1,
      quote:
        "Corey and his team at ThinkMents have been awesome business partners. Corey's knowledge of all things IT is incredible and he is always willing to give me guidance when I need help. They have been instrumental in our training programs and their professionalism is unmatched.",
      author: 'Sarah M.',
      ...
      featured: true,
      image:
        'https://images.unsplash.com/photo-1752118464988-2914fb27d0f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHRlc3RpbW9uaWFsJTIwY2xpZW50fGVufDF8fHx8MTc2NTQwNDEyOXww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    {
      id: 2,
      quote:
        'Several of my online accounts were hacked. I contacted ThinkMents and they quickly scheduled me in. Within just a few hours, my accounts had been recovered and they assisted me with setting up increased security settings. Thoroughly satisfied and extremely grateful!',
      author: 'Mike T.',
      role: 'Business Owner',
      company: 'Google Review',
      ...
      featured: true,
      image:
        'https://images.unsplash.com/photo-1758518730384-be3d205838e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBoYW5kc2hha2UlMjBtZWV0aW5nfGVufDF8fHx8MTc2NTMyNzkxM3ww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    {
      id: 3,
      quote:
        "ThinkMents has transformed our online presence. Their expertise in SEO and web design is unparalleled. We've seen a 300% increase in leads since working with them.",
      author: 'Jennifer R.',
    ...
    },
    {
      id: 4,
      quote:
        "Exceptional experience with ThinkMents! The team's professionalism and extensive knowledge truly sets them apart. From insightful consultations to precise execution, they exceeded my expectations. A reliable partner for innovative solutions.",
      author: 'David L.',
    ...
    },
    {
      id: 5,
      quote:
        'They helped us dominate local search when no one else could figure it out. Our Google Business Profile went from barely visible to top 3 in just a few months. Game-changers.',
      author: 'Robert K.',
    ...
    },
    {
      id: 6,
      quote:
        "The virtual tour ThinkMents created for our restaurant has been incredible for business. Customers tell us they felt like they'd already visited before walking through the door.",
      author: 'Maria G.',
    ...
    },
    {
      id: 7,
      quote:
        'The team is incredibly responsive. Any question or concern is addressed immediately. True partnership.',
    ...
    },
    {
      id: 8,
      quote:
        'Our Google reviews went from 12 to over 100 in less than a year. The reputation management system works.',
      author: 'Kevin Brown',
      role: 'Owner',
    ...
    },
    {
      id: 9,
      quote:
        "They don't just execute—they think strategically about our business goals. It's consulting plus execution.",
    ...
    },
    {
      id: 10,
      quote:
        'The website they built is stunning and converts visitors into leads consistently. Worth every penny.',
    ...
    },
    {
      id: 11,
      quote:
        'Corey and his team know digital marketing inside and out. 20+ years of experience really shows.',
    ...
    },
    {
      id: 12,
      quote:
        "We've been with ThinkMents for 3 years. They continue to deliver results and stay ahead of industry changes.",
      author: 'Daniel White',
      role: 'Founder',
  ...
  const filteredTestimonials = testimonials.filter(
    (testimonial) => testimonial.category.includes(activeCategory) && !testimonial.featured,
  );
  ...
  return (
    <>
      ...
      <Breadcrumb items={[{ name: 'Home', path: '/' }, { name: 'Testimonials' }]} />
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star
                  key={star}
                  className="w-10 h-10 md:w-16 md:h-16 fill-[#00B4D8] text-[#00B4D8]"
                />
              ))}
            </div>
            ...
            <p className="text-lg md:text-2xl text-gray-600 mb-12 leading-relaxed">
              103 five-star reviews and counting. Real feedback from real businesses we&apos;ve
              helped grow.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                <div
                  className="text-4xl md:text-6xl font-bold text-[#00B4D8] mb-2"
                  style={{ fontFamily: 'Playfair Display, serif' }}
                >
                  {item.stat}
                </div>
                ...
                <Card className="h-full hover:shadow-2xl transition-all duration-300 border-t-4 border-t-[#00B4D8] rounded-lg">
                  <CardContent className="p-8">
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      <p className="font-semibold text-[#1E3A5F] mb-1">{testimonial.author}</p>
      ...
      <section ref={gridRef} className="py-16 md:py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2
              className="text-3xl md:text-5xl font-bold text-[#1E3A5F] mb-8"
              style={{ fontFamily: 'Playfair Display, serif' }}
            >
              More Client Reviews
            </h2>
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                We'd love to hear from you! Your feedback helps other businesses find the right
                partner.
              </p>
            </motion.div>
            <Button
