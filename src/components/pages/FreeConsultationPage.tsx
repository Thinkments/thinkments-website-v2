...
export default function FreeConsultationPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, completely free. No credit card, no commitment, no catch. We believe in providing value upfront to show you what working with us would be like.',
    },
    {
      question: 'Will I get a sales pitch?',
      answer:
        "No. We'll share recommendations and, if it makes sense, explain how we could help. But zero pressure. Our goal is to provide genuine value whether you become a client or not.",
    },
    {
      question: 'What should I prepare?',
      answer:
        'Nothing required! But access to Google Analytics or specific questions about your marketing can help us provide more targeted insights during the session.',
    },
    {
      question: 'Can I bring my business partner?',
      answer:
        "Absolutely. The more decision-makers involved, the better. We encourage you to bring anyone who's part of your marketing decisions.",
    },
    {
      question: 'What happens after the call?',
      answer:
        "You'll receive a summary via email. If you want to work together, great—we'll discuss next steps. If not, no hard feelings. The insights are yours to keep regardless.",
    },
  ];
  ...
  return (
    <>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-2xl text-white/90 mb-16 max-w-4xl mx-auto leading-relaxed">
              In just 30 minutes, we&apos;ll analyze your current marketing, identify opportunities,
              and give you actionable recommendations—whether you hire us or not.
            </p>
                ...
                <CardContent className="p-6 md:p-10">
                  ...
                  <div className="bg-[#F8F9FA] rounded-lg p-8 mb-6 border-2 border-dashed border-gray-300 min-h-[400px] flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-500 text-center max-w-md">
                      Integration with Calendly or other scheduling tool would go here for seamless
                      appointment booking
                    </p>
                    <Button
                      asChild
                    ...
                    >
                      <a href="tel:9403151023">Or Call (940) 315-1023 to Schedule</a>
                    </Button>
                  </div>
              ...
              <div className="lg:pt-8">
                ...
                <div className="mt-10 p-6 bg-[#E8F8FC] rounded-lg border-l-4 border-[#00B4D8]">
                  <p className="text-lg text-gray-700 mb-4">
                    <strong className="text-[#1E3A5F]">Still not sure?</strong> That&apos;s okay.
                    This consultation is designed to help you make an informed decision—not pressure
                    you into one.
                  </p>
      ...
      <section
        ref={socialProofRef}
        className="py-16 md:py-20 px-4 bg-white border-y border-gray-200"
      >
            ...
            <Card className="shadow-2xl border-t-4 border-t-[#00B4D8]">
              <CardContent className="p-8 md:p-12">
                ...
                <blockquote className="text-2xl md:text-3xl text-gray-700 leading-relaxed mb-8 italic text-center">
                  &quot;I was skeptical about &apos;free consultations&apos;—usually they&apos;re
                  just sales pitches. But ThinkMents actually delivered value before asking for
                  anything. That&apos;s when I knew they were different.&quot;
                </blockquote>
            ...
            {[
              {
                ...
                title: 'Marketing & SEO',
                description:
                  'Get found on Google with comprehensive SEO strategies and local search optimization.',
                href: '/marketing-seo',
              },
              {
                icon: Globe,
                ...
                description:
                  'Custom website design and development built with performance, SEO, and conversions in mind.',
              ...
              },
              {
                ...
                description:
                  'Dominate local search with optimized Google Business Profile management and local SEO.',
              ...
              },
              {
                ...
                description:
                  'Drive immediate results with Google Ads, Facebook Ads, and retargeting campaigns.',
              ...
              },
              {
                ...
                description:
                  'Professional content creation including photography, videography, and 360° virtual tours.',
              ...
              },
              {
                ...
                title: 'AI & Automation',
                description:
                  'Leverage AI for efficiency with chatbots, workflow automation, and AI-assisted content.',
                ...
                <Card className="hover:shadow-xl transition-shadow duration-300">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-start gap-6">
                      {/* Icon */}
                      <div
                        className={`w-16 h-16 bg-gradient-to-br ${item.color} rounded-full flex items-center justify-center flex-shrink-0`}
                      >
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between mb-2">
                          <div>
                            <span className="text-sm text-[#00B4D8] font-semibold">
                              {item.step}
                            </span>
          ...
          >
            <div className="inline-block bg-white rounded-lg shadow-lg p-6 border-l-4 border-[#FF6B35]">
              <p className="text-lg text-gray-700">
                <strong className="text-[#1E3A5F]">Important:</strong> You&apos;ll leave with clear
                next steps, whether that includes working with us or not.
              </p>
            </div>
          </motion.div>
        </div>
