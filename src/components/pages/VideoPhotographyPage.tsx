  ...
  const faqs = [
    {
      ...
      answer: 'Projects range from $1,500 for simple testimonial videos to $15,000+ for complex commercial productions. We provide detailed quotes based on your specific needs and can work within most budgets.'
    },
    {
      question: 'How long does production take?',
      answer: 'Simple projects can be completed in 1-2 weeks. Larger productions typically take 3-4 weeks from concept to final delivery. Rush turnaround is available for an additional fee.'
    },
    {
      question: 'Do you provide scripts?',
      answer: 'Yes! Our team includes experienced scriptwriters who can develop concepts and scripts based on your goals. We can also work from scripts you provide.'
    },
    {
      question: 'What if we need actors or voiceover?',
      answer: 'We have a network of local talent and can coordinate casting, or we can use your team members for authentic content. Professional voiceover is available for any project.'
    },
    {
      question: 'How do we use the final video?',
      answer: 'You receive full usage rights for all content we produce. We deliver files optimized for your website, social media, presentations, and any other platforms you need.'
    },
    {
      question: 'Can you help with video strategy?',
      answer: 'Absolutely. We help you determine what types of videos will have the most impact, how to distribute them, and how to measure results.'
    }
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1634812932028-3baa37d90b52?w=1080&fit=crop)',
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                From drone footage to product photography, brand videos to social media reels—we create visual content that captures attention and drives action.
              </p>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ThinkMents has been producing professional video content since before YouTube existed. With over 20 years of visual storytelling experience, we understand that video is the most powerful medium for connecting with your audience. Our team has produced hundreds of videos for businesses across Texas and beyond—from simple testimonial videos to complex commercial productions. We combine creative vision with marketing strategy to create videos that don't just look great, but drive real business results.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-gray-600 mb-6">
              Related services that complement video production:
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/social-media" className="text-[#00B4D8] hover:text-[#1E3A5F] font-semibold underline">
              ...
              <span className="text-gray-400">|</span>
              <Link to="/immersive-experiences" className="text-[#00B4D8] hover:text-[#1E3A5F] font-semibold underline">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              View examples of our video production, photography, and virtual tours in our portfolio.
            </p>
            <Button 
              asChild 
              size="lg"
