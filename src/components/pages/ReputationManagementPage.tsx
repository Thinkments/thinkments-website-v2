  ...
  const faqs = [
    {
      ...
      answer: 'We can pursue removal of reviews that violate platform policies (fake reviews, reviews from non-customers, policy violations). Legitimate negative reviews generally cannot be removed, but we can respond professionally and generate positive reviews to provide balance.'
    },
    {
      question: 'How long does reputation recovery take?',
      answer: 'It depends on the severity of damage. Minor issues can be addressed in 2-3 months. Significant reputation problems may take 6-12 months of consistent effort to rebuild trust.'
    },
    {
      question: 'How many reviews do I need?',
      answer: 'More is better, but quality and recency matter too. Generally, aim for at least 20-30 reviews on Google to establish credibility, with consistent new reviews every month.'
    },
    {
      question: 'What if a review is fake or from a competitor?',
      answer: 'We document evidence and report policy violations to the platform. While removal isn\'t guaranteed, fake reviews often violate terms of service. We also respond professionally to minimize damage while pursuing removal.'
    },
    {
      question: 'Do you guarantee specific ratings?',
      answer: 'We don\'t guarantee ratings because we can\'t control what customers write. We do guarantee our systematic approach will improve review volume, response rate, and overall reputation trajectory.'
    },
    {
      question: 'How do you get customers to leave reviews?',
      answer: 'We make it easy. Automated follow-ups at the right time, direct review links, SMS options, and simple processes dramatically increase review rates. We don\'t offer incentives for reviews (which violates platform policies) but remove friction that prevents satisfied customers from sharing feedback.'
    }
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1080&fit=crop)',
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Your online reputation is your most valuable digital asset—and your most vulnerable. In today's connected world, a single negative review can cost you thousands in lost business, while a strong reputation drives customers to choose you over competitors. <strong>ThinkMents has been helping businesses build, protect, and recover online reputations since 2002.</strong> With over 20 years of experience managing reputations across 31 states, we understand what it takes to establish trust online and maintain it over time. Whether you're building your reputation from scratch, enhancing an already-good reputation, or recovering from reputation damage, we have the expertise and systems to help.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {[
                ...
                { stat: '84%', label: 'of people trust online reviews as much as personal recommendations' },
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                <strong>Your reputation also impacts search visibility.</strong> Google considers review quantity, quality, and recency when ranking local businesses. A strong reputation means better rankings, more visibility, and more customers.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Beyond search, your reputation is often the deciding factor when customers compare options. When similar businesses offer similar services at similar prices, reputation tips the scale.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>Reputation isn't just about damage control—it's about building an asset that drives growth.</strong> Every positive review is a permanent sales tool working for you 24/7.
              </p>
            </div>
          </motion.div>
        </div>
              ...
              {[
                {
                  ...
                  items: ['Audit current reputation across all platforms', 'Analyze review sentiment and common themes', 'Establish baseline metrics', 'Identify vulnerabilities and opportunities']
                },
                {
                  title: 'Strategy Development',
                  items: ['Create customized reputation plan', 'Define review generation targets', 'Establish response protocols', 'Set monitoring parameters']
                },
                {
                  title: 'Implementation',
                  items: ['Deploy review generation systems', 'Set up comprehensive monitoring', 'Begin response management', 'Optimize online profiles']
                },
                {
                  title: 'Ongoing Management',
                  items: ['Daily monitoring and alerts', 'Timely review responses', 'Monthly review generation campaigns', 'Quarterly strategy reviews']
                },
                {
                  title: 'Reporting & Optimization',
                  items: ['Monthly reputation reports', 'Rating and volume tracking', 'Sentiment analysis', 'Strategy refinement based on results']
                }
              ].map((phase, idx) => (
      ...
      <section ref={negativeRef} className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { title: 'Respond Quickly', description: 'Fast response shows you\'re attentive and care about customer experience. We aim to respond within 24 hours.' },
                { title: 'Respond Professionally', description: 'Never argue, get defensive, or make excuses. Acknowledge concerns, apologize for disappointment, and offer to make it right.' },
                { title: 'Take It Offline', description: 'Provide contact information to discuss details privately. Public back-and-forth rarely helps.' },
                { title: 'Address Root Causes', description: 'Identify patterns in complaints and fix underlying problems. The best reputation management is delivering great service.' },
                { title: 'Learn and Improve', description: 'Negative feedback is valuable intelligence about customer expectations and operational issues.' },
                { title: 'Follow Up', description: 'When issues are resolved, some customers will update their reviews. Even when they don\'t, future readers see your professional response.' }
              ].map((strategy, idx) => (
            ...
            <div className="mt-8 text-center bg-white rounded-lg shadow-lg p-6">
              <p className="text-lg text-gray-700">
                <strong>Our response strategies have turned angry reviewers into loyal advocates.</strong>
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { category: 'General Platforms', platforms: ['Google Business Profile', 'Facebook', 'Yelp', 'Better Business Bureau', 'Yellow Pages'] },
                { category: 'Healthcare', platforms: ['Healthgrades', 'Vitals', 'RateMDs', 'WebMD'] },
            ...
            <div className="mt-8 text-center bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-6">
              <p className="text-gray-700">
                <strong>We identify which platforms matter most for your industry and focus efforts where they'll have the greatest impact.</strong>
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#00B4D8] to-[#1E3A5F] text-white rounded-lg shadow-lg p-8">
              <p className="text-lg leading-relaxed">
                <strong>Businesses with proactive reputation programs recover faster from setbacks and maintain stronger competitive positions.</strong> Don't wait for a crisis—build your reputation asset now.
              </p>
            </div>
          </motion.div>
        </div>
