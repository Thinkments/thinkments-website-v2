  ...
  const marketingServices = [
    {
      ...
      description: 'Dominate organic search results and capture customers actively looking for your services. Our SEO services include technical optimization, on-page SEO, content strategy, and link building. We target keywords based on business value—not just search volume—ensuring rankings translate to revenue. From local businesses to national e-commerce, our SEO strategies are customized to your market and competition.'
    },
    {
      icon: FileText,
      title: 'Content Marketing',
      description: 'Attract, engage, and convert customers with valuable content. We develop content strategies that establish your expertise, answer customer questions, and rank for target keywords. Our content creation includes blog posts, guides, case studies, videos, and downloadable resources. Every piece serves a strategic purpose in your marketing funnel.'
    },
    {
      icon: Share2,
      title: 'Social Media Marketing',
      description: 'Build brand awareness and engage your audience on the platforms where they spend time. We create and manage social media content for Facebook, Instagram, LinkedIn, Twitter, and more. Our social strategies include organic content, paid advertising, community management, and influencer outreach.'
    },
    {
      icon: Mail,
      title: 'Email Marketing',
      description: 'Nurture leads and retain customers with targeted email campaigns. We design, write, and automate email sequences for lead nurturing, customer onboarding, promotions, and re-engagement. Our email marketing consistently outperforms industry benchmarks for open and click rates.'
    },
    {
      icon: DollarSign,
      title: 'Paid Advertising (PPC)',
      description: 'Generate immediate visibility with strategic paid advertising on Google, Facebook, Instagram, and LinkedIn. We manage your ad spend efficiently, focusing on ROI rather than vanity metrics. Our PPC management includes keyword research, ad creation, landing page optimization, and continuous improvement.'
    },
    {
      icon: Award,
      title: 'Reputation Management',
      description: 'Build and protect your online reputation. We implement review generation strategies, monitor mentions across the web, and respond professionally to feedback. A strong reputation improves both conversion rates and search rankings.'
    }
  ];
  ...
  const seoServices = [
    {
      icon: Code,
      title: 'Technical SEO',
      description: 'Your website\'s technical foundation determines ranking potential. We audit and optimize site speed, mobile usability, crawlability, indexation, site architecture, and Core Web Vitals. Technical issues silently kill rankings—we find and fix them so your content can perform.'
    },
    {
      icon: PenTool,
      title: 'On-Page SEO',
      description: 'Optimize every page to communicate relevance to search engines. We refine title tags, meta descriptions, headers, content, internal links, images, and schema markup. On-page optimization ensures Google understands what each page is about and ranks it accordingly.'
    },
    {
      icon: MapPin,
      title: 'Local SEO',
      description: 'Capture customers searching in your service area. We optimize Google Business Profiles, build citations, create location-specific content, and earn local backlinks. Local SEO puts you in the Map Pack and local organic results.'
    },
    {
      icon: Link2,
      title: 'Link Building',
      description: 'Build authority with quality backlinks from relevant websites. Our white-hat link building includes digital PR, content marketing, resource link building, and strategic outreach. We pursue links that drive both rankings and referral traffic.'
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Most small to mid-sized businesses invest $2,000-$7,500/month for comprehensive marketing and SEO. We\'ll recommend a budget based on your goals, competition, and growth targets.'
    },
    {
      question: 'How long until I see results?',
      answer: 'Paid advertising delivers immediate traffic. SEO typically shows meaningful results in 3-6 months, with compounding growth over 12+ months. We set realistic expectations from day one.'
    },
    {
      question: 'Do I need both marketing and SEO?',
      answer: 'They work best together, but we offer standalone services based on your needs and budget. We\'ll recommend the right approach for your situation.'
    },
    {
      question: 'What industries do you work with?',
      answer: 'We\'ve delivered results across healthcare, legal, home services, real estate, restaurants, e-commerce, professional services, and more.'
    },
    {
      question: 'How do you measure success?',
      answer: 'We track rankings, traffic, leads, conversions, and revenue. Monthly reports show exactly how marketing efforts impact your business.'
    },
    {
      question: 'What makes you different from other agencies?',
      answer: '20+ years of experience, integrated marketing and SEO under one roof, transparent reporting, and a track record of proven results. We also answer our phones.'
    },
    {
      question: 'Do you offer one-time projects or only monthly services?',
      answer: 'We offer both. One-time projects include website audits, SEO strategies, and campaign setup. Ongoing services include full management and optimization.'
    }
  ];
          ...
          >
            <div className="bg-gradient-to-br from-[#1E3A5F] to-[#2A4A6F] text-white rounded-lg shadow-lg p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed">
                Marketing and SEO aren't separate disciplines—they're two sides of the same coin. Effective marketing drives awareness and interest, while SEO ensures your business is found when customers are ready to buy. <strong>ThinkMents has been integrating marketing and search engine optimization since 2002, long before 'digital marketing' was a common term.</strong> With over 20 years of experience, we've helped hundreds of businesses across 31 states attract more customers, generate more leads, and grow revenue through strategic marketing and SEO. Our approach combines creative marketing with data-driven SEO to deliver results that impact your bottom line.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <p className="text-gray-700">SEO research informs smarter marketing targeting</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <p className="text-gray-700">Brand awareness improves click-through rates in search results</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <p className="text-gray-700">Social signals and PR support link building efforts</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <p className="text-gray-700">Paid advertising data reveals high-converting keywords for SEO</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#00B4D8] flex-shrink-0 mt-1" />
                    <p className="text-gray-700">SEO traffic insights improve marketing messaging</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#00B4D8] to-[#1E3A5F] text-white rounded-lg shadow-lg p-8">
              <p className="text-lg leading-relaxed">
                <strong>When marketing and SEO work in silos, you waste budget and miss opportunities. When they work together, results compound.</strong> Our integrated approach means your marketing dollars work harder, your SEO efforts gain traction faster, and your overall digital presence creates a competitive moat that's difficult for competitors to overcome.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/content-marketing">
                <Button variant="outline" className="border-[#FF6B35] text-[#FF6B35] hover:bg-[#FF6B35] hover:text-white px-8">
                  Content Marketing
                </Button>
              </Link>
            </div>
          ...
          >
            ...
            <div className="space-y-6">
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 1: Discovery & Audit (Weeks 1-2)</h3>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 2: Strategy Development (Weeks 2-3)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 3: Foundation Building (Months 1-2)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 4: Growth Acceleration (Months 3-6)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  <h3 className="text-2xl text-[#00B4D8] mb-3">Phase 5: Optimization & Scaling (Months 6+)</h3>
                  <ul className="space-y-2 text-white/90">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-[#00B4D8] flex-shrink-0 mt-1" />
            ...
            <div className="mt-8 bg-[#FF6B35] rounded-lg p-6">
              <p className="text-white text-lg leading-relaxed">
                <strong>Monthly reporting keeps you informed of progress</strong>, with regular strategy sessions to review results and adjust plans.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl text-[#1E3A5F] mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Real Example Results</h3>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  <strong>One client went from 500 to 3,200 monthly organic visitors in 10 months</strong> while reducing their paid advertising spend by 35%—because organic traffic replaced paid traffic.
                </p>
                <p>
                  <strong>Another client achieved #1 rankings for 12 primary keywords</strong>, generating 45+ new leads per month from SEO alone—leads that previously cost $150+ each through advertising.
                </p>
                <p className="pt-4 border-t border-gray-200">
                  We track everything and tie marketing efforts directly to revenue so you always know your ROI.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We've practiced digital marketing and SEO since 2002—through every algorithm update and industry evolution. We know what works because we've tested it through two decades of client success. From businesses in Decatur, Texas to enterprise clients across 31 states, we've refined our approach through real-world results.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Marketing and SEO work together under one roof, eliminating silos and maximizing results. Your SEO strategy informs marketing campaigns. Your marketing content strengthens SEO. This integration delivers compound results that separated agencies simply can't match.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    You'll always know exactly what we're doing, why we're doing it, and what results it's producing. Monthly reports tie marketing activities directly to business outcomes—rankings, traffic, leads, and revenue. No smoke and mirrors, just clear data.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    After an initial 3-month commitment, we work month-to-month. We earn your business through results, not contracts. This confidence comes from knowing our work consistently delivers measurable ROI.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Based in Decatur, Texas and serving clients across 31 states from North Texas to nationwide. We're accessible when you need us—no outsourced support, no offshore teams. You work directly with experienced marketing professionals.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Case studies, testimonials, and a 5.0 Google rating with 103+ reviews demonstrate our consistent ability to deliver results. Our clients stay with us for years—some for over a decade—because we continuously prove our value.
                  </p>
                </CardContent>
              </Card>
            </div>
