  ...
  const featuredIndustries = [
    {
      ...
      description:
        'HIPAA-compliant marketing, patient acquisition, and reputation management for practices, clinics, and networks.',
      stat: '$400M+ Revenue Generated',
      image:
        'https://images.unsplash.com/photo-1764885517847-79d62138cc58?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBtZWRpY2FsJTIwZmFjaWxpdHl8ZW58MXx8fHwxNzY1MzUyNjgzfDA&ixlib=rb-4.1.0&q=80&w=1080',
      services: [
        'Patient Acquisition',
        'Medical SEO',
    ...
    },
    {
      ...
      title: 'Real Estate',
      description:
        'We created the first virtual real estate tour in North Texas (2008). Complete marketing for agents, brokers, and developers.',
      stat: 'First Virtual Tour 2008',
      image:
        'https://images.unsplash.com/photo-1664849131123-7e47af8cb399?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiZWF1dGlmdWwlMjB0ZXhhcyUyMGhvbWV8ZW58MXx8fHwxNzY1NDA1MTM4fDA&ixlib=rb-4.1.0&q=80&w=1080',
    ...
    },
    {
      ...
      title: 'Home Services',
      description:
        'HVAC, plumbing, electrical—we generate leads and build reputations for service companies across Texas.',
      stat: '500+ Clients',
      image:
        'https://images.unsplash.com/photo-1660074127797-1c429fbb8cd6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBzZXJ2aWNlJTIwdGVjaG5pY2lhbnxlbnwxfHx8fDE3NjUzNTAxNTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-2xl text-white/95 max-w-4xl mx-auto leading-relaxed">
              From healthcare giants to local restaurants, we&apos;ve spent 20+ years mastering the
              unique challenges of 18 different industries. We don&apos;t do cookie-cutter
              marketing.
            </p>
          </motion.div>
              ...
              >
                <Card className="h-full overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <Badge
                      className={`absolute top-4 right-4 ${industry.tagColor} text-white border-0`}
                    >
                      {industry.tag}
                    </Badge>
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-2xl font-bold text-[#1E3A5F] mb-3">{industry.title}</h3>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-14 h-14 bg-gradient-to-br ${industry.color} rounded-lg flex items-center justify-center flex-shrink-0`}
                      >
                        <industry.icon className="w-7 h-7 text-white" />
                      </div>
                      <div className="flex-grow">
                        <h3 className="text-lg font-bold text-[#1E3A5F] mb-2">{industry.name}</h3>
      ...
      <section ref={whyRef} className="py-16 md:py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2
                className="text-3xl md:text-5xl font-bold text-[#1E3A5F] mb-6"
                style={{ fontFamily: 'Playfair Display, serif' }}
              >
                Why Industry Expertise Matters
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                A generic marketing agency might know marketing, but they don&apos;t know YOUR
                business. We&apos;ve spent 20+ years diving deep into regulations, customer
                behaviors, and competitive landscapes of each industry.
              </p>
                ...
                {[
                  {
                    ...
                    description:
                      'From HIPAA to financial regulations, we navigate complex industry rules so your marketing stays compliant.',
                  },
                  {
                    icon: Users,
                    title: 'We know your customers',
                    description:
                      "We've studied buying patterns, pain points, and decision-making processes specific to your industry.",
                  },
                  {
                    icon: Award,
                    title: "We've done this before",
                    description:
                      'Our proven strategies are built on real results from businesses just like yours—not generic best practices.',
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-6">
                <div
                  className="text-4xl font-bold text-[#00B4D8] mb-1"
                  style={{ fontFamily: 'Playfair Display, serif' }}
                >
                  20+
                </div>
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-all duration-300 border-t-4 border-t-[#00B4D8]">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-[#1E3A5F] mb-3">{study.company}</h3>
                      <div
                        className="text-3xl font-bold text-[#FF6B35] mb-3"
                        style={{ fontFamily: 'Playfair Display, serif' }}
                      >
                        {study.result}
                      </div>
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-2xl text-white/95 mb-12 leading-relaxed max-w-3xl mx-auto">
              We&apos;ve helped businesses in virtually every sector. If you have a unique
              challenge, we love a good puzzle.
            </p>
