    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-white mb-2">Image SEO Auditor</h1>
                    ...
                    <Card className="border-0 shadow-2xl border border-white/5 mb-6">
                      <CardContent className="pt-6">
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div>
                            <p className="text-2xl font-bold text-[#00B4D8]">153</p>
                            <p className="text-sm text-slate-400">Total Changes</p>
                          </div>
                          <div>
                            <p className="text-2xl font-bold text-green-600">12.4 MB</p>
