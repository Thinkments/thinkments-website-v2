    ...
    <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <Card className="border-0 shadow-2xl border border-white/5 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-2xl font-bold text-white mb-1">{stats.totalProfiles}</p>
                <p className="text-sm text-slate-400 mb-2">Total Profiles</p>
            ...
            <Card className="border-0 shadow-2xl border border-white/5 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-slate-400 mb-2">Views This Month</p>
            ...
            <Card className="border-0 shadow-2xl border border-white/5 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-slate-400 mb-2">Total Actions</p>
                <div className="flex items-center text-xs text-green-600">
                  <TrendingUp className="w-3 h-3 mr-1" />
                  +23% vs last month
                </div>
            ...
            <Card className="border-0 shadow-2xl border border-white/5 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-2xl font-bold text-white mb-1">{stats.reviewsThisMonth}</p>
                <p className="text-sm text-slate-400 mb-2">Reviews This Month</p>
                <Badge className="bg-amber-500/10 text-yellow-700">★ {stats.avgRating} avg</Badge>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-2xl border border-white/5 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-2xl font-bold text-white mb-1">{stats.pendingTasks}</p>
                <p className="text-sm text-slate-400 mb-2">Pending Tasks</p>
                <p className="text-xs text-slate-500">Reviews • Posts • Updates</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-2xl border border-white/5 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-2xl font-bold text-white mb-1">{stats.alerts}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="space-y-3">
                  {reviews.slice(0, 3).map((review) => (
                    <div key={review.id} className="p-3 border border-white/10 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-slate-500 mb-2">{review.businessName}</p>
            ...
            <Card className="border-0 shadow-2xl border border-white/5">
              ...
              <CardContent>
                <div className="space-y-3">
                  {posts.map((post) => (
                    <div key={post.id} className="p-3 border border-white/10 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            <Badge className={getPostTypeColor(post.type)}>{post.type}</Badge>
                            <span className="text-xs text-slate-500">{post.businessName}</span>
                          </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex border border-white/20 rounded-lg overflow-hidden">
                    <button
                      ...
                      className={`p-2 ${viewMode === 'grid' ? 'bg-[#00B4D8] text-white' : 'bg-[#0f172a]/40 backdrop-blur-xl text-slate-400'}`}
                    >
                      <Grid3x3 className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => setViewMode('list')}
                      className={`p-2 ${viewMode === 'list' ? 'bg-[#00B4D8] text-white' : 'bg-[#0f172a]/40 backdrop-blur-xl text-slate-400'}`}
                    >
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-100">{profile.businessName}</h3>
                          <p className="text-xs text-slate-500">{profile.clientName}</p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-gray-100">{profile.rating}</span>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-4 p-3 bg-white/5 rounded-lg">
                      <div className="text-center">
                        <p className="text-lg font-bold text-white">{profile.views}</p>
                        <p className="text-xs text-slate-400">Views</p>
                      </div>
                      <div className="text-center">
                        <p className="text-lg font-bold text-white">{profile.calls}</p>
                        <p className="text-xs text-slate-400">Calls</p>
                      </div>
                      <div className="text-center">
                        <p className="text-lg font-bold text-white">{profile.directions}</p>
                  ...
                  <CardContent className="p-4">
                    <div className="grid grid-cols-12 gap-4 items-center">
                      <div className="col-span-3 flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-semibold text-gray-100">{profile.businessName}</p>
                          <p className="text-xs text-slate-500">{profile.clientName}</p>
                        </div>
                      </div>
                      ...
                      <div className="col-span-1 text-center">
                        <p className="text-sm font-bold text-gray-100">{profile.views}</p>
                      </div>
                      <div className="col-span-1 text-center">
                        <p className="text-sm font-bold text-gray-100">{profile.calls}</p>
                      </div>
                      <div className="col-span-2">
                        <Badge className={getStatusColor(profile.status)}>{profile.status}</Badge>
                      </div>
        ...
        <div>
          ...
          <div className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">{selectedProfile.location}</p>
            ...
            <div className="grid grid-cols-4 gap-4">
              <Card className="border-0 shadow-2xl border border-white/5 cursor-pointer hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <ImageIcon className="w-8 h-8 mx-auto mb-2 text-[#00B4D8]" />
                  <p className="font-medium text-gray-100">Photos</p>
                  <p className="text-sm text-slate-500">34 images</p>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-2xl border border-white/5 cursor-pointer hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <Star className="w-8 h-8 mx-auto mb-2 text-yellow-500" />
                  <p className="font-medium text-gray-100">Reviews</p>
                  <p className="text-sm text-slate-500">{selectedProfile.reviewCount} total</p>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-2xl border border-white/5 cursor-pointer hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <FileText className="w-8 h-8 mx-auto mb-2 text-[#00B4D8]" />
                  <p className="font-medium text-gray-100">Posts</p>
                  <p className="text-sm text-slate-500">5 scheduled</p>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-2xl border border-white/5 cursor-pointer hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <BarChart3 className="w-8 h-8 mx-auto mb-2 text-purple-500" />
                  <p className="font-medium text-gray-100">Insights</p>
                  <p className="text-sm text-slate-500">View data</p>
                </CardContent>
              </Card>
            </div>
      ...
      {activeTab === 'reviews' && (
        <div>
          ...
          <div className="space-y-3">
            {reviews.map((review) => (
              <Card key={review.id} className="border-0 shadow-2xl border border-white/5">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        {renderStars(review.rating)}
                        <span className="font-semibold text-gray-100">{review.reviewerName}</span>
                        <span className="text-sm text-slate-500">{review.date}</span>
                      </div>
                      <p className="text-sm text-slate-500 mb-2">{review.businessName}</p>
                      <p className="text-slate-300 mb-3">{review.text}</p>

                      {review.reply && (
                        <div className="ml-6 p-3 bg-indigo-900/20 border-l-4 border-[#00B4D8] rounded">
      ...
      {activeTab === 'posts' && (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {posts.map((post) => (
              <Card key={post.id} className="border-0 shadow-2xl border border-white/5">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <Badge className={getPostTypeColor(post.type)}>{post.type}</Badge>
                  ...
                  <p className="text-sm text-slate-500 mb-2">{post.businessName}</p>
      ...
      {activeTab === 'bulk' && (
        <div className="space-y-6">
          ...
          <Card className="border-0 shadow-2xl border border-white/5">
            ...
            <CardContent>
              <p className="text-sm text-slate-400 mb-4">Scan all profiles for common issues</p>
          ...
          <Card className="border-0 shadow-2xl border border-white/5">
            ...
            <CardContent>
              <div className="h-64 bg-white/10 rounded-lg flex items-center justify-center">
                <p className="text-slate-500">Analytics charts would appear here</p>
              </div>
            </CardContent>
          </Card>
                  ...
                  {profiles.slice(0, 3).map((profile, idx) => (
                    <div key={profile.id} className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-100">{profile.businessName}</p>
                          <p className="text-xs text-slate-500">{profile.views} views</p>
                        </div>
                      </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-amber-900/20 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-100">3 reviews need replies</p>
                        <p className="text-xs text-slate-400">Respond within 24 hours</p>
                      </div>
                    </div>
          ...
          >
            ...
            >
              <div className="p-6 border-b border-white/10">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-white">Reply to Review</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {['update', 'event', 'offer', 'product'].map((type) => (
                        <button
                          key={type}
                          className="p-3 border-2 border-white/20 rounded-lg hover:border-[#00B4D8] capitalize"
                        >
                          {type}
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-white/20 rounded-lg"
                    />
                    <p className="text-xs text-slate-500 mt-1">1500 characters max</p>
                  </div>
