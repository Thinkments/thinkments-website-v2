      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              After editing your SEO configurations, follow these steps to deploy them to your
              website.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>1. Download the file</strong>
                </p>
                <p className="text-muted-foreground pl-4">
                  Click "Download" button to get robots.txt
                </p>

                <p>
                  <strong>2. Upload to your website</strong>
                </p>
                <p className="text-muted-foreground pl-4">
                  Place the file at your website's root directory
                </p>

                <p>
                  <strong>3. Verify deployment</strong>
                </p>
                <p className="text-muted-foreground pl-4">
                  Visit https://thinkments.com/robots.txt to confirm
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>1. Copy the JSON</strong>
                </p>
                <p className="text-muted-foreground pl-4">Click "Copy" button to get the schema</p>

                <p>
                  <strong>2. Add to website head</strong>
                </p>
                <p className="text-muted-foreground pl-4">
                  Insert as JSON-LD script in your HTML head
                </p>

                <p>
                  <strong>3. Test with tools</strong>
                </p>
                <p className="text-muted-foreground pl-4">
