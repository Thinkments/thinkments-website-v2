...
export default function UIStatesGuide() {
  const [activeSection, setActiveSection] = useState<
    'buttons' | 'forms' | 'notifications' | 'workflows' | 'sync' | 'errors' | 'confirmations' | 'collaboration'
  >('buttons');
    ...
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      <div className="p-8">
        ...
        {activeSection === 'buttons' && (
          <div className="space-y-8">
            ...
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Primary Buttons (Teal #00B4D8)</h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">bg-[#00B4D8] text-white</code>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">bg-[#0096b8] shadow-lg</code>
                  </div>
                </div>

                {/* Active/Pressed State */}
                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Active/Pressed State</div>
                  <div className="flex items-center space-x-4">
                    <motion.button
                      whileTap={{ scale: 0.95 }}
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">bg-[#007A94] scale-0.95</code>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">bg-gray-300 text-gray-500 cursor-not-allowed</code>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">spinner + "Publishing..."</code>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">bg-green-600 + checkmark</code>
                  </div>
                </div>
              </div>
            </Card>
            ...
            {/* Secondary Buttons */}
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Secondary Buttons (Outline)</h2>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">border-[#00B4D8] text-[#00B4D8]</code>
                  </div>
                </div>
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Hover State</div>
                  <div className="flex items-center space-x-4">
                    <Button variant="outline" className="border-[#00B4D8] text-[#00B4D8] bg-[#E6F7FA]">
                      Save Draft
                    </Button>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">spinner + disabled</code>
                  </div>
                </div>
              </div>
            </Card>
            ...
            {/* Danger Buttons */}
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Danger Buttons (Delete Actions)</h2>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">border-red-600 text-red-600</code>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <code className="text-xs bg-gray-100 px-3 py-1 rounded">bg-red-600 + warning text</code>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6 max-w-md">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Default/Empty State</label>
                  <Input placeholder="Enter your title..." />
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Focused State</label>
                  <Input 
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Filled State</label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Success/Valid State</label>
            ...
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6 max-w-md">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Closed Default</label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Multi-Select with Tags</label>
            ...
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-8">
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" className="rounded border-gray-300 text-[#00B4D8] focus:ring-[#00B4D8]" defaultChecked />
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-[#00B4D8] bg-blue-50 rounded-lg p-8 text-center">
                    ...
                    <p className="text-lg font-medium text-[#00B4D8] mb-2">
                      Drop file here
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="border border-gray-300 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <span className="text-sm font-medium text-gray-700">Uploading image.jpg...</span>
                    </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Button onClick={() => triggerToast('success')} size="sm" className="bg-green-600 hover:bg-green-700 text-white">
                    Show Success
                  </Button>
                  <Button onClick={() => triggerToast('error')} size="sm" className="bg-red-600 hover:bg-red-700 text-white">
                    Show Error
                  </Button>
                  <Button onClick={() => triggerToast('warning')} size="sm" className="bg-yellow-600 hover:bg-yellow-700 text-white">
                    Show Warning
                  </Button>
                  <Button onClick={() => triggerToast('info')} size="sm" className="bg-blue-600 hover:bg-blue-700 text-white">
                    Show Info
                  </Button>
                </div>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 shadow-lg max-w-md">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-green-700 mt-1">Blog post published successfully!</div>
                      </div>
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 shadow-lg max-w-md">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-red-700 mt-1">Failed to save. Please try again.</div>
                      </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 shadow-lg max-w-md">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-yellow-700 mt-1">You have unsaved changes.</div>
                      </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 shadow-lg max-w-md">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-blue-700 mt-1">Your report is being generated...</div>
                      </div>
            ...
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6">
                <div>
                  <Button onClick={() => setShowModal(true)} className="bg-[#00B4D8] hover:bg-[#0096b8] text-white">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                  <div className="max-w-md mx-auto bg-white rounded-lg shadow-xl p-6">
                    ...
                    <p className="text-gray-600 mb-6">
                      Are you sure you want to delete "{'"SEO Best Practices 2025"'}? This action cannot be undone.
                    </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-[#00B4D8] h-2 rounded-full transition-all" style={{ width: '75%' }} />
                    </div>
                  </div>
                </div>

                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Skeleton Placeholder</div>
                ...
                {[
                  ...
                  <div key={i} className="relative">
                    <div className="flex items-start space-x-4">
                      <div className={`w-12 h-12 bg-${item.color}-600 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0`}>
                        {item.step}
                      </div>
                      <div className="flex-1">
                    ...
                    {i < 6 && (
                      <div className="ml-6 mt-4 mb-4 border-l-2 border-gray-300 h-8" />
                    )}
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="relative">
                    ...
                    {i < 7 && (
                      <div className="ml-5 mt-3 mb-3 border-l-2 border-gray-300 h-6" />
                    )}
                  </div>
                ))}
              </div>
        ...
        {activeSection === 'sync' && (
          <div className="space-y-8">
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Connection Status Indicators</h2>
            ...
            {/* Build Status */}
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Build/Deploy Status (Netlify)</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  ...
                  <div className="w-full bg-yellow-200 rounded-full h-2">
                    <div className="bg-yellow-600 h-2 rounded-full transition-all" style={{ width: '68%' }} />
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-red-700">Build error in sitemap generation</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
        ...
        {activeSection === 'confirmations' && (
          <div className="space-y-8">
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Delete Confirmation Patterns</h2>
              
              <div className="space-y-6">
                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Click Again to Confirm</div>
                  <div className="flex items-center space-x-4">
                    {deleteState === 'default' ? (
                      <Button 
                        variant="outline" 
                ...
                <div>
                  ...
                  <div className="max-w-md bg-white rounded-lg shadow-xl p-6 border-2 border-dashed border-gray-300">
                    <h3 className="text-xl font-bold text-[#1E3A5F] mb-2">Delete "SEO Best Practices 2025"?</h3>
                    <p className="text-gray-600 mb-6">
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Type to Confirm (Critical)</div>
                  <div className="max-w-md bg-white rounded-lg shadow-xl p-6 border-2 border-dashed border-gray-300">
                    <h3 className="text-xl font-bold text-[#1E3A5F] mb-2">Delete All Client Data?</h3>
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4">
                      <div className="flex items-start space-x-2">
                        <AlertTriangle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                        <div className="text-sm text-red-700">
                          This will permanently delete all client data, reports, and analytics. This cannot be undone.
                        </div>
                      </div>
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Type <code className="bg-gray-200 px-2 py-0.5 rounded">DELETE</code> to confirm:
                      </label>
                ...
                <div className="space-y-2 mb-6">
                  {[
                    ...
                    <div key={i} className="flex items-center space-x-2">
                      <CheckCircle className={`w-4 h-4 ${item.isWarning ? 'text-yellow-600' : 'text-green-600'}`} />
        ...
        {activeSection === 'collaboration' && (
          <div className="space-y-8">
            <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">Real-Time Collaboration Indicators</h2>
              
              <div className="space-y-6">
                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Currently Being Edited Banner</div>
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-yellow-900">Jane Smith is editing this post</div>
                ...
                <div>
                  ...
                  <div className="border border-gray-200 rounded-lg divide-y">
                    {[
                      { user: 'Jane Smith', action: 'published a blog post', time: '2 min ago', avatar: 'JS' },
                      { user: 'John Doe', action: 'updated client profile', time: '15 min ago', avatar: 'JD' },
                      { user: 'Sarah Wilson', action: 'created new page', time: '1 hour ago', avatar: 'SW' }
                    ].map((activity, i) => (
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-700 mb-3">Team Members Online</div>
                  <div className="flex items-center space-x-3">
        ...
        {showToast && (
          ...
          >
            <div className={`${
              ...
              <div className="flex items-start space-x-3">
                {toastType === 'success' && <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0" />}
                {toastType === 'error' && <XCircle className="w-5 h-5 text-red-600 flex-shrink-0" />}
                {toastType === 'warning' && <AlertTriangle className="w-5 h-5 text-yellow-600 flex-shrink-0" />}
                ...
                <button
                  ...
                  className={`${
                    ...
                    toastType === 'warning' ? 'text-yellow-600 hover:text-yellow-800' :
