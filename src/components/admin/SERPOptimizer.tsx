      ...
      {(viewType === 'edit' || viewType === 'preview') && selectedPage && (
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Right: SERP Preview */}
            <div>
              <Card className="border-0 shadow-[0_0_30px_rgba(79,70,229,0.1)] border border-white/5 bg-[#0f172a]/80 backdrop-blur-xl relative z-10 bg-[#0f172a]/80 backdrop-blur-xl relative z-10 hover:border-indigo-500/30 hover:shadow-[0_0_40px_rgba(79,70,229,0.2)] transition-all duration-300 sticky top-6">
                <CardHeader>
                  <div className="flex items-center justify-between">
              ...
              <div className="p-6">
                ...
                {wizardStep === 4 && (
                  <div>
                    ...
                    <div className="mb-6">
                      <Card className="border-0 shadow-[0_0_30px_rgba(79,70,229,0.1)] border border-white/5 bg-[#0f172a]/80 backdrop-blur-xl relative z-10 bg-[#0f172a]/80 backdrop-blur-xl relative z-10 hover:border-indigo-500/30 hover:shadow-[0_0_40px_rgba(79,70,229,0.2)] transition-all duration-300 mb-4">
                        <CardContent className="pt-6">
          ...
          >
            ...
            >
              <div className="p-6">
                ...
                {/* AI Analysis */}
                <Card className="border-0 shadow-[0_0_30px_rgba(79,70,229,0.1)] border border-white/5 bg-[#0f172a]/80 backdrop-blur-xl relative z-10 bg-[#0f172a]/80 backdrop-blur-xl relative z-10 hover:border-indigo-500/30 hover:shadow-[0_0_40px_rgba(79,70,229,0.2)] transition-all duration-300 mt-6">
                  <CardHeader>
