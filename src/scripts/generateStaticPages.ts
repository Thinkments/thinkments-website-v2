...
const pages: PageConfig[] = [
  ...
  },
  {
    ...
    description:
      'Discover the ThinkMents story - from startup to leading digital marketing agency. Learn about our values, mission, and commitment to client success.',
    ...
    structuredData: {
      ...
      description:
        'The story behind ThinkMents digital marketing agency and our journey to success.',
    },
  },
  {
    path: 'services',
  ...
  },
  {
    ...
    description:
      'Professional virtual tours and 360° photography services. Showcase your business with immersive experiences that engage customers and drive sales.',
    keywords:
      'virtual tours, 360 photography, immersive experiences, business tours, real estate tours',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'Service',
...

  {
    ...
    description:
      'High-quality videography services including promotional videos, event coverage, product videos, and drone footage for impactful marketing campaigns.',
    keywords:
      'videography, video production, promotional videos, event videography, drone footage, video marketing',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'Service',
  ...
  },
  {
    ...
    description:
      'Cutting-edge AI optimization services to enhance your digital marketing, automate processes, and improve customer experiences with artificial intelligence.',
    keywords:
      'AI optimization, artificial intelligence, marketing automation, AI technology, digital transformation',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'Service',
  ...
  },
  {
    ...
    description:
      'ThinkMents serves businesses across Alabama, Tennessee, and Georgia with comprehensive digital marketing services. Find your local coverage area.',
    keywords:
      'service areas, Alabama digital marketing, Tennessee marketing, Georgia marketing, local SEO',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
  ...
  },
  {
    ...
    description:
      'Explore ThinkMents success stories and case studies. See how our digital marketing strategies have helped businesses achieve remarkable growth and ROI.',
    keywords:
      'case studies, success stories, marketing results, client testimonials, ROI, business growth',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
  ...
  },
  {
    ...
    description:
      'Stay updated with the latest digital marketing trends, SEO tips, web design insights, and marketing strategies from the ThinkMents expert team.',
    keywords:
      'digital marketing blog, SEO tips, marketing insights, web design trends, marketing strategies',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'Blog',
  ...
  },
  {
    ...
    description:
      'Browse ThinkMents digital marketing products and services. Templates, guides, audits, and specialized packages to boost your business growth.',
    keywords:
      'digital marketing store, marketing templates, SEO audits, marketing guides, business packages',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'Store',
  ...
  },
  {
    ...
    description:
      'Get a personalized quote for your digital marketing needs. Free consultation and custom pricing for web design, SEO, and marketing services.',
    keywords:
      'get quote, free estimate, digital marketing pricing, custom quote, marketing consultation',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
  ...
  },
  {
    ...
    description:
      'ThinkMents design transfer agreement outlining the terms for transferring design assets and intellectual property to clients.',
    keywords:
      'design transfer, asset transfer, intellectual property, design ownership, transfer agreement',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
...
const blogPosts = [
  {
    ...
    description:
      'Discover the latest digital marketing trends for 2024. AI integration, voice search, personalization, and emerging strategies to stay ahead.',
    keywords:
      'digital marketing trends 2024, marketing predictions, AI marketing, voice search, personalization',
  },
  {
    path: 'blog/seo-best-practices',
    title: 'SEO Best Practices 2024 - Complete Guide by ThinkMents',
    description:
      'Master SEO with our comprehensive guide to best practices. Technical SEO, content optimization, and ranking strategies that work.',
    keywords:
      'SEO best practices, search engine optimization, ranking strategies, technical SEO, content optimization',
  },
  {
    path: 'blog/web-design-principles',
    title: 'Web Design Principles for Better Conversions - ThinkMents Guide',
    description:
      'Essential web design principles that improve user experience and increase conversions. UX design, mobile optimization, and conversion tips.',
    keywords:
      'web design principles, UX design, conversion optimization, mobile design, user experience',
  },
];
...
const storeProducts = [
  {
    ...
    description:
      'Comprehensive SEO audit report with detailed analysis, recommendations, and action plan to improve your website search rankings.',
  ...
  },
  {
    ...
    description:
      'Premium website design templates for businesses. Fully responsive, customizable, and optimized for conversions.',
...
pages.forEach((page) => {
  ...
  const filePath = page.path ? join('public', `${page.path}.html`) : join('public', 'index.html');
