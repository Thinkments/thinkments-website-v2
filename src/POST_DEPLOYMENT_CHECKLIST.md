...
**Explanation:**
This is expected with Figma Make's architecture. See `/SITEMAP_HTML_STATUS_EXPLAINED.md` for full
details.
...
**Remember:** The "Sitemap is HTML" warning is expected and harmless. Focus on content quality and
